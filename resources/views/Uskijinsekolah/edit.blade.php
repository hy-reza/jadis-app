...
<body>
	<div class="container">
		...
		@endif
		<form method="post" action="{{action('UskijinsekolahController@update', $id)}}">
			@csrf
			...
			<div class="row">
				...
				<div class="form-group col-md-4">
					...
					<input type="text" class="form-control" name="nomer_surat" value="{{$Uskijinsekolah->nomer_surat}}">
				</div>
			</div>
			<div class="row">
				<div class="col-md-4"></div>
				<div class="form-group col-md-4">
					...
					<input type="text" class="form-control" name="nama_lengkap" value="{{$Uskijinsekolah->nama_lengkap}}" onkeyup="this.value = this.value.toUpperCase();">
				</div>
			</div>
			<div class="row">
				<div class="col-md-4"></div>
				<div class="form-group col-md-4">
					...
					<input type="text" class="form-control" name="kelas" value="{{$Uskijinsekolah->kelas}}" onkeyup="this.value = this.value.toUpperCase();">
				</div>
			</div>
    <div class="row">
      <div class="col-md-4"></div>
      <div class="form-group col-md-4">
        ...
        <input type="text" class="form-control" name="nama_sekolah" value="{{$Uskijinsekolah->nama_sekolah}}" onkeyup="this.value = this.value.toUpperCase();">
      </div>
    </div>
    <div class="row">
      <div class="col-md-4"></div>
      <div class="form-group col-md-4">
        <label for="name"> Memperingati HUT ke :</label>
        <input type="text" class="form-control" name="nomer_kemerdekaan" value="{{$Uskijinsekolah->nomer_kemerdekaan}}">
      </div>
    </div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    <label for="name">Pada Tahun :</label>
    <input type="year" class="form-control" name="tahun_kemerdekaan" value="{{$Uskijinsekolah->tahun_kemerdekaan}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    <label for="name"> Hari Diselenggarakannya :</label>
    <input type="text" class="form-control" name="hari" value="{{$Uskijinsekolah->hari}}" onkeyup="this.value = this.value.toUpperCase();">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    <label for="name">Tanggal Diselenggarakannya :</label>
    <input type="date" class="form-control" name="tgl" value="{{$Uskijinsekolah->tgl}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    ...
    <input type="date" class="form-control" name="tgl_hari_ini" value="{{$Uskijinsekolah->tgl_hari_ini}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    ...
    <input type="text" class="form-control" name="nama_kades" value="{{$Uskijinsekolah->nama_kades}}" onkeyup="this.value = this.value.toUpperCase();">
  </div>
</div>
		<div class="row">
			<div class="col-md-4"></div>
