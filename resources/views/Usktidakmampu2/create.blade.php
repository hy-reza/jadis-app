        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Data Surat Keterangan Tidak  Mampu</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Menu</a></li>
                        <li class="breadcrumb-item active">Data Surat Ket. Tidak Mampu</li>
                    </ol>
                </div>
            </div>
            <!-- <div class="col" align="center">
                <p>
                  <h1 class="text"><br><br><br><br><br>Anda login sebagai Administrator</h1>
						...
						<body>
              <div class="container">
								<h2>Input Data Keterangan Tidak  Mampu 2</h2>
								@if ($errors->any())
								...
								@endif
								<form method="post" action="{{url('Usktidakmampu2')}}">
								@csrf
                ...
                <h4 align="center">Nomer Surat</h4>
                    ...
                    <input type="text" class="form-control" name="nomer_surat" placeholder="nomer surat" onkeyup="this.value = this.value.toUpperCase();">
									</div>
								</div>
              ...
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="ttl" placeholder="tempat, tgl lahir" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="status" placeholder="status" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>
              ...
              <h4 align="center">Tempat Pelayanan Pengobatan</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="tempat_pengobatan" placeholder="tempat pengobatan">
                </div>
              </div>

              <h4 align="center">Penyakit yang Diderita</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="sakit" placeholder="penyakit yang diderita">
                </div>
              </div>

              <h4 align="center">Daftar DTKS pada Tahun</h4>
              ...
              <h4 align="center">Nomer Urut</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="no_urut" placeholder="nomer urut">
                </div>
              </div>
              ...
              <h4 align="center">Nama Yang Berkepentingan</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="nama_berkepentingan" placeholder="nama yang berkepentingan" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>
              ...
              <h4 align="center">No Camat</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="no" placeholder="nomer nip">
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="nama_camat" placeholder="Nama Camat" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>
