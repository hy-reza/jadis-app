         ...
         <tbody>
           @foreach ($Uskijinsekolah as $Uskijinsekolah)
                            <tr>
                                ...
                                <td><a href="{{ action('UskijinsekolahController@edit', $Uskijinsekolah['id']) }}"
                                        class="btn btn-warning">Ubah</a><br><br>
                                    <a href="{{ action('UskijinsekolahController@show', $Uskijinsekolah['id']) }}"
                                        class="btn btn-warning">Surat</a><br><br>
                                    <form
                                        action="{{ action('UskijinsekolahController@destroy', $Uskijinsekolah['id']) }}"
                                        method="post">
                                        @csrf
