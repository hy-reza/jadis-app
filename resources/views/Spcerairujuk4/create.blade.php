        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Data Surat Pengajuan Cerai Rujuk</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Menu</a></li>
                        <li class="breadcrumb-item active">Data Surat Pengajuan Cerai Rujuk</li>
                    </ol>
                </div>
            </div>
            <!-- <div class="col" align="center">
              ...
              <div class="container">
								...
								@endif
								<form method="post" action="{{url('Spcerairujuk4')}}">
								@csrf
