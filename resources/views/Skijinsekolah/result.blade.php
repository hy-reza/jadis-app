...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container">
              <form action="{{ route('Skijinsekolah.search')}}" method="get">
            ...
            <div class="row m-t-25">
                <div class="col-sm-5 col-lg-3">
                    <table style="width: 100px" id="datatable" class="table table-striped table-bordered">
                            <tr>
                                <td>
                                    <a href="{{route ('Skijinsekolah.create')}}" class="btn btn-primary btn-sm">Tambah Data Ket Ijin Sekolah</a>
                                </td>
                            </tr>
                    </table>
                    </div>
                      ...
                      <th>AKSI</th>
									...
									<tbody>
										@foreach($result as $Skijinsekolah)
										<tr>
											<td>{{$Skijinsekolah['id']}}</td>
											<td>{{$Skijinsekolah['nama_lengkap']}}</td>
											<td>{{$Skijinsekolah['kelas']}}</td>
                      <td>{{$Skijinsekolah['nama_sekolah']}}</td>
                      <td>{{$Skijinsekolah['nomer_kemerdekaan']}}</td>
                      <td>{{$Skijinsekolah['tahun_kemerdekaan']}}</td>
                      <td>{{$Skijinsekolah['hari']}}</td>
                      <td>{{$Skijinsekolah['tgl']}}</td>
                      <td>{{$Skijinsekolah['tgl_hari_ini']}}</td>
                      <td>{{$Skijinsekolah['nama_kades']}}</td>

											<td><a href="{{action('SkijinsekolahController@edit', $Skijinsekolah['id'])}}" class="btn btn-warning">Ubah</a><br><br>
                        <a href="{{action('SkijinsekolahController@show', $Skijinsekolah['id'])}}" class="btn btn-warning">Surat</a><br><br>
												<form action="{{action('SkijinsekolahController@destroy', $Skijinsekolah['id'])}}" method="post">
													@csrf
