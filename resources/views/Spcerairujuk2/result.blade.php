...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container">
              <form action="{{ route('Spcerairujuk2.search')}}" method="get">
                <input type="text" name="Spcerairujuk2" class="form-control" placeholder="Search..." style="width: 80%; display: inline;">
            ...
            <div class="row m-t-25">
                <div class="col-sm-5 col-lg-3">
                    <table style="width: 100px" id="datatable" class="table table-striped table-bordered">
                            <tr>
                                <td>
                                    <a href="{{route ('Spcerairujuk2.create')}}" class="btn btn-primary btn-sm">Tambah Data Pengajuan Cerai Rujuk</a>
                                </td>
                            </tr>
                    </table>
                    </div>
                      ...
                      <th>AKSI</th>
									...
									<tbody>
										@foreach($result as $Spcerairujuk2)
										<tr>
											<td>{{$Spcerairujuk2['id']}}</td>
											<td>{{$Spcerairujuk2['nama']}}</td>
											<td>{{$Spcerairujuk2['nik']}}</td>
                      <td>{{$Spcerairujuk2['ttl']}}</td>
                      <td>{{$Spcerairujuk2['pekerjaan']}}</td>
                      <td>{{$Spcerairujuk2['alamat']}}</td>
                      <td>{{$Spcerairujuk2['nama_sah']}}</td>
                      <td>{{$Spcerairujuk2['nik_sah']}}</td>
                      <td>{{$Spcerairujuk2['ttl_sah']}}</td>
                      <td>{{$Spcerairujuk2['pekerjaan_sah']}}</td>
                      <td>{{$Spcerairujuk2['alamat_sah']}}</td>
                      <td>{{$Spcerairujuk2['suami']}}</td>
                      <td>{{$Spcerairujuk2['negara']}}</td>
                      <td>{{$Spcerairujuk2['tgl_hari_ini']}}</td>
                      <td>{{$Spcerairujuk2['nama_kades']}}</td>
											<td><a href="{{action('Spcerairujuk2Controller@edit', $Spcerairujuk2['id'])}}" class="btn btn-warning">Ubah</a><br><br>
                        <a href="{{action('Spcerairujuk2Controller@show', $Spcerairujuk2['id'])}}" class="btn btn-warning">Surat</a><br><br>
												<form action="{{action('Spcerairujuk2Controller@destroy', $Spcerairujuk2['id'])}}" method="post">
													@csrf
