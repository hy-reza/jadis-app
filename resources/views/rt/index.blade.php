...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container">
              <form action="{{ route('rt.search')}}" method="get">
            ...
            <div class="row m-t-25">
                <div class="col-sm-6 col-lg-3">
                    <table style="width: 100px" id="datatable" class="table table-striped table-bordered">
                            <tr>
                                <td>
                                    <a href="{{route ('rt.create')}}" class="btn btn-primary btn-sm">Tambah Data RT</a>
                                </td>
                            </tr>
                    </table>
                    </div>
                      ...
                      <th>Edit</th>
									...
									<tbody>
										...
										<tr>
											...
											<td>{{$rt['rt']}}</td>
											<td>{{$rt['alamat']}}</td>
											<td><a href="{{action('RtController@edit', $rt['id'])}}" class="btn btn-warning">Ubah</a></td>
											<td>
												<form action="{{action('RtController@destroy', $rt['id'])}}" method="post">
													@csrf
