        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Data Pengajuan Cerai Rujuk 2</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Data</a></li>
                        <li class="breadcrumb-item active">Data Pengajuan Cerai Rujuk 2</li>
                    </ol>
                </div>
            </div>
<body>
	<div class="container">
		...
		@endif
		<form method="post" action="{{action('Uspcerairujuk2Controller@update', $id)}}">
			@csrf
			...
			<div class="row">
				...
				<div class="form-group col-md-4">
					...
					<input type="text" class="form-control" name="nomer_surat" value="{{$Uspcerairujuk2->nomer_surat}}">
				</div>
			</div>
			<div class="row">
				<div class="col-md-4"></div>
				<div class="form-group col-md-4">
					...
					<input type="text" class="form-control" name="nama" value="{{$Uspcerairujuk2->nama}}" onkeyup="this.value = this.value.toUpperCase();">
				</div>
			</div>
			<div class="row">
				<div class="col-md-4"></div>
				<div class="form-group col-md-4">
					...
					<input type="text" class="form-control" name="nik" value="{{$Uspcerairujuk2->nik}}">
				</div>
			</div>
    <div class="row">
      <div class="col-md-4"></div>
      <div class="form-group col-md-4">
        ...
        <input type="text" class="form-control" name="ttl" value="{{$Uspcerairujuk2->ttl}}" onkeyup="this.value = this.value.toUpperCase();">
      </div>
    </div>
  <div class="row">
    <div class="col-md-4"></div>
    <div class="form-group col-md-4">
      ...
      <input type="text" class="form-control" name="pekerjaan" value="{{$Uspcerairujuk2->pekerjaan}}">
    </div>
  </div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    ...
    <input type="text" class="form-control" name="alamat" value="{{$Uspcerairujuk2->alamat}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    <label for="name">Nama :</label>
    <input type="text" class="form-control" name="nama_sah" value="{{$Uspcerairujuk2->nama_sah}}" onkeyup="this.value = this.value.toUpperCase();">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    <label for="name">NIK :</label>
    <input type="text" class="form-control" name="nik_sah" value="{{$Uspcerairujuk2->nik_sah}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    <label for="name">Tempat, Tanggal Lahir :</label>
    <input type="text" class="form-control" name="ttl_sah" value="{{$Uspcerairujuk2->ttl_sah}}" onkeyup="this.value = this.value.toUpperCase();">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    <label for="name">Pekerjaan :</label>
    <input type="text" class="form-control" name="pekerjaan_sah" value="{{$Uspcerairujuk2->pekerjaan_sah}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    <label for="name">Alamat :</label>
    <input type="text" class="form-control" name="alamat_sah" value="{{$Uspcerairujuk2->alamat_sah}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    ...
    <input type="text" class="form-control" name="suami" value="{{$Uspcerairujuk2->suami}}" onkeyup="this.value = this.value.toUpperCase();">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    ...
    <input type="text" class="form-control" name="negara" value="{{$Uspcerairujuk2->negara}}" onkeyup="this.value = this.value.toUpperCase();">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    ...
    <input type="date" class="form-control" name="tgl_hari_ini" value="{{$Uspcerairujuk2->tgl_hari_ini}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    ...
    <input type="text" class="form-control" name="nama_kades" value="{{$Uspcerairujuk2->nama_kades}}" onkeyup="this.value = this.value.toUpperCase();">
  </div>
</div>
		<div class="row">
			<div class="col-md-4"></div>
