...
<body class="fix-header fix-sidebar">
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Data Keterangan Penerimaan Pensiun</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Data</a></li>
                        <li class="breadcrumb-item active">Data Ket. Penerimaan Pensiun</li>
                    </ol>
                </div>
            </div>
	...
	<div class="container">
		...
		@endif
		<form method="post" action="{{action('UskpenerimaanpensiunController@update', $id)}}">
			@csrf
			...
			<div class="row">
				...
				<div class="form-group col-md-4">
					...
					<input type="text" class="form-control" name="nomer_surat" value="{{$Uskpenerimaanpensiun->nomer_surat}}">
				</div>
			</div>
			<div class="row">
				<div class="col-md-4"></div>
				<div class="form-group col-md-4">
					...
					<input type="text" class="form-control" name="nama_lengkap" value="{{$Uskpenerimaanpensiun->nama_lengkap}}" onkeyup="this.value = this.value.toUpperCase();">
				</div>
			</div>
			<div class="row">
				<div class="col-md-4"></div>
				<div class="form-group col-md-4">
					...
					<input type="text" class="form-control" name="jenis_kelamin" value="{{$Uskpenerimaanpensiun->jenis_kelamin}}" onkeyup="this.value = this.value.toUpperCase();">
				</div>
			</div>
    <div class="row">
      <div class="col-md-4"></div>
      <div class="form-group col-md-4">
        ...
        <input type="text" class="form-control" name="ttl" value="{{$Uskpenerimaanpensiun->ttl}}">
      </div>
    </div>
    <div class="row">
      <div class="col-md-4"></div>
      <div class="form-group col-md-4">
        ...
        <input type="text" class="form-control" name="kewarganegaraan" value="{{$Uskpenerimaanpensiun->kewarganegaraan}}" onkeyup="this.value = this.value.toUpperCase();">
      </div>
    </div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    ...
    <input type="text" class="form-control" name="agama" value="{{$Uskpenerimaanpensiun->agama}}" onkeyup="this.value = this.value.toUpperCase();">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    ...
    <input type="text" class="form-control" name="status_perkawinan" value="{{$Uskpenerimaanpensiun->status_perkawinan}}" onkeyup="this.value = this.value.toUpperCase();">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    ...
    <input type="text" class="form-control" name="pekerjaan" value="{{$Uskpenerimaanpensiun->pekerjaan}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    ...
    <input type="text" class="form-control" name="alamat" value="{{$Uskpenerimaanpensiun->alamat}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    <label for="name">Dipergunakan Untuk :</label>
    <input type="text" class="form-control" name="dipergunakaan_untuk" value="{{$Uskpenerimaanpensiun->dipergunakaan_untuk}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    ...
    <input type="text" class="form-control" name="tujuan" value="{{$Uskpenerimaanpensiun->tujuan}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    <label for="name">Surat Pengantar Dari :</label>
    <input type="text" class="form-control" name="surat_pengantar" value="{{$Uskpenerimaanpensiun->surat_pengantar}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    <label for="name">Daf Kartu Keluarga :</label>
    <input type="text" class="form-control" name="daf_kk" value="{{$Uskpenerimaanpensiun->daf_kk}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    ...
    <input type="text" class="form-control" name="no_ktp" value="{{$Uskpenerimaanpensiun->no_ktp}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    <label for="name">Yang Tercantum dalam SK Penerimaan Pensiun :</label>
    <input type="text" class="form-control" name="nama_bin" value="{{$Uskpenerimaanpensiun->nama_bin}}" onkeyup="this.value = this.value.toUpperCase();">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    ...
    <input type="date" class="form-control" name="tgl_hari_ini" value="{{$Uskpenerimaanpensiun->tgl_hari_ini}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    <label for="name">Nama Pemegang Surat :</label>
    <input type="text" class="form-control" name="nama_pemegang" value="{{$Uskpenerimaanpensiun->nama_pemegang}}" onkeyup="this.value = this.value.toUpperCase();">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    ...
    <input type="text" class="form-control" name="nama_kades" value="{{$Uskpenerimaanpensiun->nama_kades}}" onkeyup="this.value = this.value.toUpperCase();">
  </div>
</div>
		<div class="row">
			<div class="col-md-4"></div>
