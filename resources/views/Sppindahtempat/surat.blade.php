...
<html lang="en" dir="ltr">
  ...
  <body>
    @foreach($Sppindahtempat as $Sppindahtempat)
    <table align="center">
      <tr>
        <td height="30"></td>
      </tr>
    ...
    <table align="center" width="700" >
      ...
      <tr>
        <td>Nama</td>
        <td width="430"> : {{$Sppindahtempat['nama']}}</td>
        <td></td>
      </tr>
      <tr>
        <td>Tempat/Tanggal Lahir</td>
        <td width="430"> : {{$Sppindahtempat['ttl']}}</td>
        <td></td>
      </tr>
      <tr>
        <td>NIK</td>
        <td width="430"> : {{$Sppindahtempat['nik']}}</td>
        <td></td>
      </tr>
      <tr>
        <td><b>Alamat Asal</b></td>
        <td width="430"> : {{$Sppindahtempat['alamat_asal']}}</td>
        <td></td>
      </tr>
      <tr>
        <td>Desa/Kelurahan</td>
        <td width="430"> : {{$Sppindahtempat['desa_kelurahan']}}</td>
        <td></td>
      </tr>
      <tr>
        <td>Kabupaten/Kota</td>
        <td width="430"> : {{$Sppindahtempat['kabupaten_kota']}}</td>
        <td></td>
      </tr>
      <tr>
        <td>Provinsi</td>
        <td width="430"> : {{$Sppindahtempat['provinsi']}}</td>
        <td></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td width="430"> : {{$Sppindahtempat['desa_kelurahan_rt_rw_tujuan']}}</td>
        <td></td>
      </tr>
      <tr>
        <td>Kecamatan</td>
        <td width="430"> : {{$Sppindahtempat['kecamatan']}}</td>
        <td></td>
      </tr>
      <tr>
        <td>Kabupaten/Kota</td>
        <td width="430"> : {{$Sppindahtempat['kabupaten_kota_tujuan']}}</td>
        <td></td>
      </tr>
      <tr>
        <td>Provinsi</td>
        <td width="430"> : {{$Sppindahtempat['provinsi_tujuan']}}</td>
        <td></td>
      </tr>
      <tr>
        <td>Alasan Pindah</td>
        <td width="430"> : {{$Sppindahtempat['alasan_pindah']}}</td>
        <td></td>
      </tr>
      <tr>
  ...
  <table  align="center"  width="700" >
    ...
    <table  align="center"  width="700" border="1" >
      ...
      <tr>
        ...
        <td><center>{{$Sppindahtempat['nik_1']}}</center></td>
        <td><center>{{$Sppindahtempat['nama_1']}}</center></td>
        <td><center>{{$Sppindahtempat['tgl_lahir_1']}}</center></td>
        <td><center>{{$Sppindahtempat['hubungan_keluarga_1']}}</center></td>
      </tr>
      <tr>
        <td><center>2</center></td>
        <td><center>{{$Sppindahtempat['nik_2']}}</center></td>
        <td><center>{{$Sppindahtempat['nama_2']}}</center></td>
        <td><center>{{$Sppindahtempat['tgl_lahir_2']}}</center></td>
        <td><center>{{$Sppindahtempat['hubungan_keluarga_2']}}</center></td>
      </tr>
    </table>
    <table  align="center"  width="700" >
      <tr>
    ...
    <table  align="center"  width="700" >
      <tr>
        ...
        <td width="40"></td>
        <td width="270"><center>Junrejo, {{$Sppindahtempat['tgl_hari_ini']}}</center></td>
      </tr>
      <tr>
        <td><center></center></td>
        <td></td>
      ...
      <tr>
        ...
        <td></td>
        <td><center> <u> <b> {{$Sppindahtempat['nama_pemohon']}} </b></u></center></td>
      </tr>
    </table>
      <table  align="center"  width="700" >
        <tr>
