...
<html lang="en" dir="ltr">
  ...
  <body>
    @foreach($Spkematian as $Spkematian)
    <table align="center">
      <tr>
        <td height="30"></td>
      </tr>
    ...
    <table align="center" width="700">
      ...
      <tr>
        <td>Nama</td>
        <td width="500">: <b>{{$Spkematian['nama']}}</b></td>
        <td></td>
      </tr>
      <tr>
        <td>NIK</td>
        <td width="500">: {{$Spkematian['nik']}}</td>
        <td></td>
      </tr>
      <tr>
        <td>Nomor KK</td>
        <td width="500">: {{$Spkematian['nomor_kk']}}</td>
        <td></td>
      </tr>
      <tr>
        <td>Jenis Kelamin</td>
        <td width="500">: {{$Spkematian['jenis_kelamin']}}</td>
        <td></td>
      </tr>
      <tr>
        <td>Pekerjaan</td>
        <td width="500">: {{$Spkematian['pekerjaan']}}</td>
        <td></td>
      </tr>
      <tr>
        <td>Alamat</td>
        <td width="500">: {{$Spkematian['alamat']}}<br></td>
        <td></td>
      </tr>
      <tr>
        <td>Status Hubungan Keluarga</td>
        <td width="500">: {{$Spkematian['status_hubungan_keluarga']}}<br></td>
        <td></td>
      </tr>
      <tr>
      ...
      <tr>
        <td>Nama</td>
        <td width="500">: <b>{{$Spkematian['nama_meninggal']}}</b></td>
        <td></td>
      </tr>
      <tr>
        <td>NIK</td>
        <td width="500">: {{$Spkematian['nik_meninggal']}}</td>
        <td></td>
      </tr>
      <tr>
        <td>No.KK</td>
        <td width="500">: {{$Spkematian['nomor_kk_meninggal']}}</td>
        <td></td>
      </tr>
      <tr>
        <td>Tempat, Tanggak Lahir</td>
        <td width="500">: {{$Spkematian['ttl_meninggal']}}</td>
        <td></td>
      </tr>
      <tr>
        <td>Alamat</td>
        <td width="500">: {{$Spkematian['alamat_meninggal']}}</td>
        <td></td>
      </tr>
        <td colspan="2">Telah meninggal dunia pada Tanggal {{$Spkematian['tanggal_meninggal']}}, Pukul {{$Spkematian['pukul_meninggal']}}<br>
          Di alamat {{$Spkematian['dialamat_meninggal']}}
        </td>
        <td></td>
      </tr>
      <tr>
    ...
    <table  align="center" >
      <tr>
        ...
        <td width="40"></td>
        <td width="270"><center>Junrejo,{{$Spkematian['tgl_hari_ini']}}</center></td>
      </tr>
      <tr>
        <td><center></center></td>
        <td></td>
      ...
      <tr>
        <td><center></center></td>
        <td></td>
        <td><center> <u> {{$Spkematian['nama_pernyataan']}} </u></center></td>
      </tr>
    </table>
    <table align="center">
    <tr>
    ...
    <tr>
      <td><center> <b><u>{{$Spkematian['nama_rt']}} </u></b></center></td>
      <td><center> <b><u> {{$Spkematian['nama_kades']}} </u></b></center></td>
      <td><center> <b><u> {{$Spkematian['nama_rw']}} </u></b></center></td>
    </tr>
  </table>
  @endforeach
  </body>
