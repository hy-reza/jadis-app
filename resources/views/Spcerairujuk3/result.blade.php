...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container">
              <form action="{{ route('Spcerairujuk3.search')}}" method="get">
                <input type="text" name="Spcerairujuk3" class="form-control" placeholder="Search..." style="width: 80%; display: inline;">
                ...
                <div class="col-sm-5 col-lg-3">
                    <table style="width: 100px" id="datatable" class="table table-striped table-bordered">
                      ...
                      <th>AKSI</th>
									...
									<tbody>
										@foreach($result as $Spcerairujuk3)
										<tr>
											<td>{{$Spcerairujuk3['id']}}</td>
											<td>{{$Spcerairujuk3['nama']}}</td>
											<td>{{$Spcerairujuk3['alamat']}}</td>
                      <td>{{$Spcerairujuk3['nama_angkat']}}</td>
                      <td>{{$Spcerairujuk3['alamat_angkat']}}</td>
                      <td>{{$Spcerairujuk3['nama_anak']}}</td>
                      <td>{{$Spcerairujuk3['jenis_kelamin']}}</td>
                      <td>{{$Spcerairujuk3['tempat']}}</td>
                      <td>{{$Spcerairujuk3['tgl_hari_ini']}}</td>
                      <td>{{$Spcerairujuk3['nama_kades']}}</td>
											<td><a href="{{action('Spcerairujuk3Controller@edit', $Spcerairujuk3['id'])}}" class="btn btn-warning">Ubah</a><br><br>
                        <a href="{{action('Spcerairujuk3Controller@show', $Spcerairujuk3['id'])}}" class="btn btn-warning">Surat</a><br><br>
												<form action="{{action('Spcerairujuk3Controller@destroy', $Spcerairujuk3['id'])}}" method="post">
													@csrf
