        ...
        <div class="page-wrapper">
            ...
            <div class="container">
              <form action="{{ route('Sktidakmampu2.search')}}" method="get">
                <input type="text" name="Sktidakmampu2" class="form-control" placeholder="Search..." style="width: 80%; display: inline;">
            ...
            <div class="row m-t-25">
                <div class="col-sm-5 col-lg-3">
                    <table style="width: 100px" id="datatable" class="table table-striped table-bordered">
                            <tr>
                                <td>
                                    <a href="{{route ('Sktidakmampu2.create')}}" class="btn btn-primary btn-sm">Tambah Data Ket Tidak Mampu</a>
                                </td>
                            </tr>
                    </table>
                    </div>
                      ...
                      <th>AKSI</th>
									...
									<tbody>
										@foreach($result as $Sktidakmampu2)
										<tr>
											<td>{{$Sktidakmampu2['id']}}</td>
											<td>{{$Sktidakmampu2['nama']}}</td>
											<td>{{$Sktidakmampu2['jenis_kelamin']}}</td>
                      <td>{{$Sktidakmampu2['ttl']}}</td>
                      <td>{{$Sktidakmampu2['agama']}}</td>
                      <td>{{$Sktidakmampu2['status']}}</td>
                      <td>{{$Sktidakmampu2['pekerjaan']}}</td>
                      <td>{{$Sktidakmampu2['alamat']}}</td>
                      <td>{{$Sktidakmampu2['tempat_pengobatan']}}</td>
                      <td>{{$Sktidakmampu2['sakit']}}</td>
                      <td>{{$Sktidakmampu2['tahun']}}</td>
                      <td>{{$Sktidakmampu2['no_urut']}}</td>
                      <td>{{$Sktidakmampu2['tgl_hari_ini']}}</td>
                      <td>{{$Sktidakmampu2['nama_berkepentingan']}}</td>
                      <td>{{$Sktidakmampu2['nama_kades']}}</td>
                      <td>{{$Sktidakmampu2['no']}}</td>
                      <td>{{$Sktidakmampu2['nama_camat']}}</td>
											<td><a href="{{action('Sktidakmampu2Controller@edit', $Sktidakmampu2['id'])}}" class="btn btn-warning">Ubah</a><br><br>
                        <a href="{{action('Sktidakmampu2Controller@show', $Sktidakmampu2['id'])}}" class="btn btn-warning">Surat</a><br><br>
												<form action="{{action('Sktidakmampu2Controller@destroy', $Sktidakmampu2['id'])}}" method="post">
													@csrf
