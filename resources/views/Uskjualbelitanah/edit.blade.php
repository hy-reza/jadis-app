...
<body class="fix-header fix-sidebar">
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Data Surat Keterangan Jual Beli Tanah</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Menu</a></li>
                        <li class="breadcrumb-item active">Data Surat Ket. Jual Beli Tanah</li>
                    </ol>
                </div>
            </div>
	...
	<div class="container">
		...
		@endif
		<form method="post" action="{{action('UskjualbelitanahController@update', $id)}}">
			@csrf
			...
			<div class="row">
				...
				<div class="form-group col-md-4">
					...
					<input type="text" class="form-control" name="nama_lengkap" value="{{$Uskjualbelitanah->nama_lengkap}}" onkeyup="this.value = this.value.toUpperCase();">
				</div>
			</div>
			<div class="row">
				<div class="col-md-4"></div>
				<div class="form-group col-md-4">
					...
					<input type="text" class="form-control" name="ttl" value="{{$Uskjualbelitanah->ttl}}">
				</div>
			</div>
    <div class="row">
      <div class="col-md-4"></div>
      <div class="form-group col-md-4">
        ...
        <input type="text" class="form-control" name="agama" value="{{$Uskjualbelitanah->agama}}" onkeyup="this.value = this.value.toUpperCase();">
      </div>
    </div>
    <div class="row">
      <div class="col-md-4"></div>
      <div class="form-group col-md-4">
        ...
        <input type="text" class="form-control" name="pekerjaan" value="{{$Uskjualbelitanah->pekerjaan}}">
      </div>
    </div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    ...
    <input type="text" class="form-control" name="alamat" value="{{$Uskjualbelitanah->alamat}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    <label for="name"> Nama_lengkap pihak 2 :</label>
    <input type="text" class="form-control" name="nama_lengkap_1" value="{{$Uskjualbelitanah->nama_lengkap_1}}" onkeyup="this.value = this.value.toUpperCase();">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    <label for="name">Tempat Tanggal Lahir :</label>
    <input type="text" class="form-control" name="ttl_1" value="{{$Uskjualbelitanah->ttl_1}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    <label for="name">Agama :</label>
    <input type="text" class="form-control" name="agama_1" value="{{$Uskjualbelitanah->agama_1}}" onkeyup="this.value = this.value.toUpperCase();">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    <label for="name">Pekerjaan :</label>
    <input type="text" class="form-control" name="pekerjaan_1" value="{{$Uskjualbelitanah->pekerjaan_1}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    <label for="name">Alamat :</label>
    <input type="text" class="form-control" name="alamat_1" value="{{$Uskjualbelitanah->alamat_1}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    ...
    <input type="text" class="form-control" name="panjang" value="{{$Uskjualbelitanah->panjang}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    ...
    <input type="text" class="form-control" name="lebar" value="{{$Uskjualbelitanah->lebar}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    <label for="name">Utara Tanah Milik :</label>
    <input type="text" class="form-control" name="utara" value="{{$Uskjualbelitanah->utara}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    <label for="name">Selatan Tanah Milik :</label>
    <input type="text" class="form-control" name="selatan" value="{{$Uskjualbelitanah->selatan}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    <label for="name">Timur Tanah Milik :</label>
    <input type="text" class="form-control" name="timur" value="{{$Uskjualbelitanah->timur}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    <label for="name">Barat Tanah Milik :</label>
    <input type="text" class="form-control" name="barat" value="{{$Uskjualbelitanah->barat}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    ...
    <input type="text" class="form-control" name="nilai" value="{{$Uskjualbelitanah->nilai}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    <label for="name">Terbilang :</label>
    <input type="text" class="form-control" name="terbilang" value="{{$Uskjualbelitanah->terbilang}}" onkeyup="this.value = this.value.toUpperCase();">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    <label for="name">Kontan :</label>
    <input type="text" class="form-control" name="kontan" value="{{$Uskjualbelitanah->kontan}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    ...
    <input type="date" class="form-control" name="tgl_hari_ini" value="{{$Uskjualbelitanah->tgl_hari_ini}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    <label for="name">Nama Pihak 1 :</label>
    <input type="text" class="form-control" name="nama_pihak_1" value="{{$Uskjualbelitanah->nama_pihak_1}}" onkeyup="this.value = this.value.toUpperCase();">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    <label for="name">Nama Pihak 2 :</label>
    <input type="text" class="form-control" name="nama_pihak_2" value="{{$Uskjualbelitanah->nama_pihak_2}}" onkeyup="this.value = this.value.toUpperCase();">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    ...
    <input type="text" class="form-control" name="nama_kades" value="{{$Uskjualbelitanah->nama_kades}}" onkeyup="this.value = this.value.toUpperCase();">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    <label for="name">Nama Saksi 1 :</label>
    <input type="text" class="form-control" name="saksi_1" value="{{$Uskjualbelitanah->saksi_1}}" onkeyup="this.value = this.value.toUpperCase();">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    <label for="name">Nama Saksi 2 :</label>
    <input type="text" class="form-control" name="saksi_2" value="{{$Uskjualbelitanah->saksi_2}}" onkeyup="this.value = this.value.toUpperCase();">
  </div>
</div>
		<div class="row">
			<div class="col-md-4"></div>
