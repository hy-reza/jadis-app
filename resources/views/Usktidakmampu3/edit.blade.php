        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Data Keterangan Tidak Mampu 3</h3> </div>
...
<body>
	<div class="container">
		...
		@endif
		<form method="post" action="{{action('Usktidakmampu3Controller@update', $id)}}">
			@csrf
			...
			<div class="row">
				...
				<div class="form-group col-md-4">
					...
					<input type="text" class="form-control" name="nomer_surat" value="{{$Usktidakmampu3->nomer_surat}}" onkeyup="this.value = this.value.toUpperCase();">
				</div>
			</div>
			<div class="row">
				<div class="col-md-4"></div>
				<div class="form-group col-md-4">
					...
					<input type="text" class="form-control" name="nama" value="{{$Usktidakmampu3->nama}}" onkeyup="this.value = this.value.toUpperCase();">
				</div>
			</div>
			<div class="row">
				<div class="col-md-4"></div>
				<div class="form-group col-md-4">
					...
					<input type="text" class="form-control" name="jenis_kelamin" value="{{$Usktidakmampu3->jenis_kelamin}}" onkeyup="this.value = this.value.toUpperCase();">
				</div>
			</div>
    <div class="row">
      <div class="col-md-4"></div>
      <div class="form-group col-md-4">
        ...
        <input type="text" class="form-control" name="ttl" value="{{$Usktidakmampu3->ttl}}" onkeyup="this.value = this.value.toUpperCase();">
      </div>
    </div>
    <div class="row">
      <div class="col-md-4"></div>
      <div class="form-group col-md-4">
        ...
        <input type="text" class="form-control" name="agama" value="{{$Usktidakmampu3->agama}}" onkeyup="this.value = this.value.toUpperCase();">
      </div>
    </div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    ...
    <input type="text" class="form-control" name="status" value="{{$Usktidakmampu3->status}}" onkeyup="this.value = this.value.toUpperCase();">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    ...
    <input type="text" class="form-control" name="pekerjaan" value="{{$Usktidakmampu3->pekerjaan}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    ...
    <input type="text" class="form-control" name="alamat" value="{{$Usktidakmampu3->alamat}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    ...
    <input type="year" class="form-control" name="tahun" value="{{$Usktidakmampu3->tahun}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    ...
    <input type="date" class="form-control" name="tgl_hari_ini" value="{{$Usktidakmampu3->tgl_hari_ini}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    ...
    <input type="text" class="form-control" name="nama_kades" value="{{$Usktidakmampu3->nama_kades}}" onkeyup="this.value = this.value.toUpperCase();">
  </div>
</div>
		<div class="row">
			<div class="col-md-4"></div>
