...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container">
              <form action="{{ route('Spcerairujuk4.search')}}" method="get">
                <input type="text" name="Spcerairujuk4" class="form-control" placeholder="Search..." style="width: 80%; display: inline;">
            ...
            <div class="row m-t-25">
                <div class="col-sm-5 col-lg-3">
                    <table style="width: 100px" id="datatable" class="table table-striped table-bordered">
                            <tr>
                                <td>
                                    <a href="{{route ('Spcerairujuk4.create')}}" class="btn btn-primary btn-sm">Tambah Data Pengajuan Cerai Rujuk</a>
                                </td>
                            </tr>
                    </table>
                    </div>
                      ...
                      <th>AKSI</th>
									...
									<tbody>
										@foreach($result as $Spcerairujuk4)
										<tr>
											<td>{{$Spcerairujuk4['id']}}</td>
											<td>{{$Spcerairujuk4['nama']}}</td>
											<td>{{$Spcerairujuk4['ttl']}}</td>
                      <td>{{$Spcerairujuk4['agama']}}</td>
                      <td>{{$Spcerairujuk4['pekerjaan']}}</td>
                      <td>{{$Spcerairujuk4['alamat']}}</td>
                      <td>{{$Spcerairujuk4['nama_istri']}}</td>
											<td>{{$Spcerairujuk4['ttl_istri']}}</td>
                      <td>{{$Spcerairujuk4['agama_istri']}}</td>
                      <td>{{$Spcerairujuk4['pekerjaan_istri']}}</td>
                      <td>{{$Spcerairujuk4['alamat_istri']}}</td>
                      <td>{{$Spcerairujuk4['nama_wali']}}</td>
											<td>{{$Spcerairujuk4['ttl_wali']}}</td>
                      <td>{{$Spcerairujuk4['agama_wali']}}</td>
                      <td>{{$Spcerairujuk4['pekerjaan_wali']}}</td>
                      <td>{{$Spcerairujuk4['alamat_wali']}}</td>
                      <td>{{$Spcerairujuk4['tgl_pelaksaan']}}</td>
											<td>{{$Spcerairujuk4['maskawin']}}</td>
                      <td>{{$Spcerairujuk4['saksi1']}}</td>
                      <td>{{$Spcerairujuk4['saksi2']}}</td>
                      <td>{{$Spcerairujuk4['tgl_hari_ini']}}</td>
                      <td>{{$Spcerairujuk4['nama_kades']}}</td>
											<td><a href="{{action('Spcerairujuk4Controller@edit', $Spcerairujuk4['id'])}}" class="btn btn-warning">Ubah</a><br><br>
                        <a href="{{action('Spcerairujuk4Controller@show', $Spcerairujuk4['id'])}}" class="btn btn-warning">Surat</a><br><br>
												<form action="{{action('Spcerairujuk4Controller@destroy', $Spcerairujuk4['id'])}}" method="post">
													@csrf
