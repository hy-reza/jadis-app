            ...
            <!-- <div class="col" align="center">
                <p>
                  <h1 class="text"><br><br><br><br><br>Anda login sebagai Administrator</h1>
						...
						<body>
              <div class="container">
								<h2>Input Data Keterangan Jual Beli Tanah</h2>
								@if ($errors->any())
								...
								@endif
								<form method="post" action="{{url('Uskjualbelitanah')}}">
								@csrf
                <h2>Yang bertanda tangan dibawah ini :</h2>

                <h3 align="center">Biodata Pihak Pertama</h3>
                <h4 align="center">Nama Lengkap</h4>

								<div class="row">
									<div class="col-md-4"></div>
									<div class="form-group col-md-4">
                    <input type="text" class="form-control" name="nama_lengkap" placeholder="nama lengkap" onkeyup="this.value = this.value.toUpperCase();">
									</div>
								</div>
							</div>
              ...
              <h4 align="center">Agama</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="agama" placeholder="agama" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>
              ...
              <h2 align="center">Biodata Pihak Kedua</h2>
              <h4 align="center">Nama Lengkap</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="nama_lengkap_1" placeholder="nama_lengkap_1" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="ttl_1" placeholder="ttl_1">
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="agama_1" placeholder="agama_1" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="pekerjaan_1" placeholder="pekerjaan_1">
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="alamat_1" placeholder="alamat_1">
                </div>
              </div>

              <h4 align="center">panjang</h4>
              ...
              <h4 align="center">Utara Tanah Milik</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="utara" placeholder="utara" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>

              <h4 align="center">Selatan Tanah Milik</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="selatan" placeholder="selatan" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>

              <h4 align="center">Timur Tanah Milik</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="timur" placeholder="timur" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>

              <h4 align="center">Barat Tanah Milik</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="barat" placeholder="barat" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>

              <h4 align="center">Nilai Sebesar</h4>
              ...
              <h4 align="center">Terbilang</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="terbilang" placeholder="terbilang" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>

              <h4 align="center">Kotan</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="kontan" placeholder="kontan">
                </div>
              </div>
              ...
              <h4 align="center">Nama Pihak 1</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="nama_pihak_1" placeholder="nama_pihak_1" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>

              <h4 align="center">Nama Pihak 2</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="nama_pihak_2" placeholder="nama_pihak_2" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="nama_kades" placeholder="nama_kades" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>

              <h4 align="center">Nama Saksi 1</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="saksi_1" placeholder="saksi_1" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>

              <h4 align="center">Nama Saksi 2</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="saksi_2" placeholder="saksi_2" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>
