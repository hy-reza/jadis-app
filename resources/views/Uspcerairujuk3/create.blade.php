        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Data Surat Pengajuan Cerai Rujuk 3</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Menu</a></li>
                        <li class="breadcrumb-item active">Data Surat Pengajuan Cerai Rujuk 3</li>
                    </ol>
                </div>
            </div>
            <!-- <div class="col" align="center">
              ...
              <div class="container">
								...
								@endif
								<form method="post" action="{{url('Uspcerairujuk3')}}">
								@csrf
              ...
              <h4 align="center">Nama Ortu Angkat/Pengampu</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="nama_angkat" placeholder="nama_angkat" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>

              <h4 align="center">Alamat Ortu Angkat/Pengampu </h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="alamat_angkat" placeholder="alamat lengkap">
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="nama_anak" placeholder="nama lengkap" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>
              ...
              <h4 align="center">Tempat Pernikahan</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="tempat" placeholder="tempat pernikahan">
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="date" class="form-control" name="tgl_hari_ini" placeholder="tanggal">
                </div>
              </div>
