...
<body>
	<div class="container">
		...
		@endif
		<form method="post" action="{{action('UskmeninggalduniaController@update', $id)}}">
			@csrf
			...
			<div class="row">
				...
				<div class="form-group col-md-4">
					...
					<input type="text" class="form-control" name="nomer_surat" value="{{$Uskmeninggaldunia->nomer_surat}}">
				</div>
			</div>
			<div class="row">
				<div class="col-md-4"></div>
				<div class="form-group col-md-4">
					...
					<input type="text" class="form-control" name="hari" value="{{$Uskmeninggaldunia->hari}}" onkeyup="this.value = this.value.toUpperCase();">
				</div>
			</div>
			<div class="row">
				<div class="col-md-4"></div>
				<div class="form-group col-md-4">
					...
					<input type="date" class="form-control" name="tanggal" value="{{$Uskmeninggaldunia->tanggal}}">
				</div>
			</div>
    <div class="row">
      <div class="col-md-4"></div>
      <div class="form-group col-md-4">
        ...
        <input type="time" class="form-control" name="jam" value="{{$Uskmeninggaldunia->jam}}">
      </div>
    </div>
    <div class="row">
      <div class="col-md-4"></div>
      <div class="form-group col-md-4">
        ...
        <input type="text" class="form-control" name="nama_alm" value="{{$Uskmeninggaldunia->nama_alm}}" onkeyup="this.value = this.value.toUpperCase();">
      </div>
    </div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    <label for="name">Umur Almarhum :</label>
    <input type="text" class="form-control" name="umur_alm" value="{{$Uskmeninggaldunia->umur_alm}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    ...
    <input type="text" class="form-control" name="rt" value="{{$Uskmeninggaldunia->rt}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    ...
    <input type="text" class="form-control" name="rw" value="{{$Uskmeninggaldunia->rw}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    <label for="name">Penyebab Meninggalnya Karena :</label>
    <input type="text" class="form-control" name="penyebab_meninggal" value="{{$Uskmeninggaldunia->penyebab_meninggal}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    <label for="name">Nama Saudara :</label>
    <input type="text" class="form-control" name="nama_saudara" value="{{$Uskmeninggaldunia->nama_saudara}}" onkeyup="this.value = this.value.toUpperCase();">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    ...
    <input type="text" class="form-control" name="tempat_bekerja" value="{{$Uskmeninggaldunia->tempat_bekerja}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    ...
    <input type="date" class="form-control" name="tgl_hari_ini" value="{{$Uskmeninggaldunia->tgl_hari_ini}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    ...
    <input type="text" class="form-control" name="nama_kades" value="{{$Uskmeninggaldunia->nama_kades}}" onkeyup="this.value = this.value.toUpperCase();">
  </div>
</div>
		<div class="row">
			<div class="col-md-4"></div>
