    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
            ...
            <div class="container">
              ...
              @endif
              <form method="post" action="{{url('Udatapenduduk')}}">
              @csrf
              <div class="row">
            ...
            <div class="row">
              <div class="col-md-4"></div>
              <div class="form-group col-md-4">
                <input type="text" class="form-control" name="tempat_ttl" placeholder="tempat_ttl" onkeyup="this.value = this.value.toUpperCase();">
              </div>
            </div>
            <div class="row">
              <div class="col-md-4"></div>
            ...
            <div class="row">
              <div class="col-md-4"></div>
              <div class="form-group col-md-4">
                <input type="text" class="form-control" name="pendidikan_terakhir" placeholder="pendidikan_terakhir">
              </div>
            </div>
            <div class="row">
              <div class="col-md-4"></div>
