...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container">
              <form action="{{ route('Uskmeninggaldunia.search')}}" method="get">
                <input type="text" name="Uskmeninggaldunia" class="form-control" placeholder="Search..." style="width: 80%; display: inline;">
            ...
            <div class="row m-t-25">
                <div class="col-sm-5 col-lg-3">
                    <table style="width: 100px" id="datatable" class="table table-striped table-bordered">
                            <tr>
                                <td>
                                    <a href="{{route ('Uskmeninggaldunia.create')}}" class="btn btn-primary btn-sm">Tambah Data Ket Meninggal Dunia</a>
                                </td>
                            </tr>
                    </table>
                    </div>
                      ...
                      <th>AKSI</th>
									...
									<tbody>
                    @foreach($result as $Uskmeninggaldunia)
										<tr>
											<td>{{$Uskmeninggaldunia['id']}}</td>
                      <td>{{$Uskmeninggaldunia['nomer_surat']}}</td>
											<td>{{$Uskmeninggaldunia['hari']}}</td>
											<td>{{$Uskmeninggaldunia['tanggal']}}</td>
                      <td>{{$Uskmeninggaldunia['jam']}}</td>
                      <td>{{$Uskmeninggaldunia['nama_alm']}}</td>
                      <td>{{$Uskmeninggaldunia['umur_alm']}}</td>
                      <td>{{$Uskmeninggaldunia['rt']}}</td>
                      <td>{{$Uskmeninggaldunia['rw']}}</td>
                      <td>{{$Uskmeninggaldunia['nama_saudara']}}</td>
                      <td>{{$Uskmeninggaldunia['tempat_bekerja']}}</td>
                      <td>{{$Uskmeninggaldunia['tgl_hari_ini']}}</td>
                      <td>{{$Uskmeninggaldunia['nama_kades']}}</td>

											<td><a href="{{action('UskmeninggalduniaController@edit', $Uskmeninggaldunia['id'])}}" class="btn btn-warning">Ubah</a><br><br>
                        <a href="{{action('UskmeninggalduniaController@show', $Uskmeninggaldunia['id'])}}" class="btn btn-warning">Surat</a><br><br>
												<form action="{{action('UskmeninggalduniaController@destroy', $Uskmeninggaldunia['id'])}}" method="post">
													@csrf
