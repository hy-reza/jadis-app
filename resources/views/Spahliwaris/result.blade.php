...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container">
              <form action="{{ route('Spahliwaris.search')}}" method="get">
                <input type="text" name="Spahliwaris" class="form-control" placeholder="Search..." style="width: 80%; display: inline;">
            ...
            <div class="row m-t-25">
                <div class="col-sm-5 col-lg-3">
                    <table style="width: 100px" id="datatable" class="table table-striped table-bordered">
                            <tr>
                                <td>
                                    <a href="{{route ('Spahliwaris.create')}}" class="btn btn-primary btn-sm">Tambah Data Pernyataan Ahli Waris</a>
                                </td>
                            </tr>
                    </table>
                    </div>
                      ...
                      <th>AKSI</th>
									...
									<tbody>
										@foreach($result as $Spahliwaris)
										<tr>
											<td>{{$Spahliwaris['id']}}</td>
											<td>{{$Spahliwaris['nama_alm']}}</td>
											<td>{{$Spahliwaris['nomer_akte_kematian']}}</td>
                      <td>{{$Spahliwaris['hari']}}</td>
                      <td>{{$Spahliwaris['tanggal']}}</td>
                      <td>{{$Spahliwaris['bulan']}}</td>
                      <td>{{$Spahliwaris['tahun']}}</td>
                      <td>{{$Spahliwaris['status_suami_istri']}}</td>
                      <td>{{$Spahliwaris['nama_suami_istri']}}</td>
                      <td>{{$Spahliwaris['nama_anak']}}</td>
                      <td>{{$Spahliwaris['umur_anak']}}</td>
                      <td>{{$Spahliwaris['pekerjaan_anak']}}</td>
                      <td>{{$Spahliwaris['alamat_anak']}}</td>
                      <td>{{$Spahliwaris['no_req']}}</td>
                      <td>{{$Spahliwaris['tgl_hari_ini']}}</td>
                      <td>{{$Spahliwaris['nama_camat']}}</td>
                      <td>{{$Spahliwaris['nama_kades']}}</td>
											<td><a href="{{action('SpahliwarisController@edit', $Spahliwaris['id'])}}" class="btn btn-warning">Ubah</a><br><br>
                        <a href="{{action('SpahliwarisController@show', $Spahliwaris['id'])}}" class="btn btn-warning">Surat</a><br><br>
												<form action="{{action('SpahliwarisController@destroy', $Spahliwaris['id'])}}" method="post">
													@csrf
