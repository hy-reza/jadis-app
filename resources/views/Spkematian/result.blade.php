...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container">
              <form action="{{ route('Spkematian.search')}}" method="get">
                <input type="text" name="Spkematian" class="form-control" placeholder="Search..." style="width: 80%; display: inline;">
            ...
            <div class="row m-t-25">
                <div class="col-sm-5 col-lg-3">
                    <table style="width: 100px" id="datatable" class="table table-striped table-bordered">
                            <tr>
                                <td>
                                    <a href="{{route ('Spkematian.create')}}" class="btn btn-primary btn-sm">Tambah Data Pernyataan Kematian</a>
                                </td>
                            </tr>
                    </table>
                    </div>
                      ...
                      <th>AKSI</th>
									...
									<tbody>
										@foreach($result as $Spkematian)
										<tr>
											<td>{{$Spkematian['id']}}</td>
											<td>{{$Spkematian['nama']}}</td>
											<td>{{$Spkematian['nik']}}</td>
                      <td>{{$Spkematian['nomor_kk']}}</td>
                      <td>{{$Spkematian['jenis_kelamin']}}</td>
                      <td>{{$Spkematian['pekerjaan']}}</td>
                      <td>{{$Spkematian['alamat']}}</td>
                      <td>{{$Spkematian['status_hubungan_keluarga']}}</td>
                      <td>{{$Spkematian['nama_meninggal']}}</td>
                      <td>{{$Spkematian['nik_meninggal']}}</td>
                      <td>{{$Spkematian['nomor_kk_meninggal']}}</td>
                      <td>{{$Spkematian['ttl_meninggal']}}</td>
                      <td>{{$Spkematian['alamat_meninggal']}}</td>
                      <td>{{$Spkematian['tanggal_meninggal']}}</td>
                      <td>{{$Spkematian['pukul_meninggal']}}</td>
                      <td>{{$Spkematian['dialamat_meninggal']}}</td>
                      <td>{{$Spkematian['tgl_hari_ini']}}</td>
                      <td>{{$Spkematian['nama_pernyataan']}}</td>
                      <td>{{$Spkematian['nama_rt']}}</td>
                      <td>{{$Spkematian['nama_kades']}}</td>
                      <td>{{$Spkematian['nama_rw']}}</td>
											<td><a href="{{action('SpkematianController@edit', $Spkematian['id'])}}" class="btn btn-warning">Ubah</a><br><br>
                        <a href="{{action('SpkematianController@show', $Spkematian['nik'])}}" class="btn btn-warning">Surat</a><br><br>
												<form action="{{action('SpkematianController@destroy', $Spkematian['id'])}}" method="post">
													@csrf
