            ...
            <!-- <div class="col" align="center">
                <p>
                  <h1 class="text"><br><br><br><br><br>Anda login sebagai Administrator</h1>
						...
						<body>
              <div class="container">
								<h2>Input Data Keterangan Tidak  Mampu 3</h2>
								@if ($errors->any())
								...
								@endif
								<form method="post" action="{{url('Usktidakmampu3')}}">
								@csrf
              ...
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="pekerjaan" placeholder="pekerjaan" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>
              ...
              <h4 align="center">Terdaftar pada Tahun</h4>
              ...
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="nama_kades" placeholder="Nama kepala desa">
                </div>
              </div>
