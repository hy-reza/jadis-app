...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container">
              <form action="{{ route('Skjualbelitanah.search')}}" method="get">
            ...
            <div class="row m-t-25">
                <div class="col-sm-5 col-lg-3">
                    <table style="width: 100px" id="datatable" class="table table-striped table-bordered">
                            <tr>
                                <td>
                                    <a href="{{route ('Skjualbelitanah.create')}}" class="btn btn-primary btn-sm">Tambah Data Ket Jual Beli Tanah</a>
                                </td>
                            </tr>
                    </table>
                    </div>
                      ...
                      <th>AKSI</th>
									...
									<tbody>
										@foreach($result as $Skjualbelitanah)
										<tr>
											<td>{{$Skjualbelitanah['id']}}</td>
											<td>{{$Skjualbelitanah['nama_lengkap']}}</td>
											<td>{{$Skjualbelitanah['ttl']}}</td>
                      <td>{{$Skjualbelitanah['agama']}}</td>
                      <td>{{$Skjualbelitanah['pekerjaan']}}</td>
                      <td>{{$Skjualbelitanah['alamat']}}</td>
                      <td>{{$Skjualbelitanah['nama_lengkap_1']}}</td>
                      <td>{{$Skjualbelitanah['ttl_1']}}</td>
                      <td>{{$Skjualbelitanah['agama_1']}}</td>
                      <td>{{$Skjualbelitanah['pekerjaan_1']}}</td>
                      <td>{{$Skjualbelitanah['alamat_1']}}</td>
                      <td>{{$Skjualbelitanah['panjang']}}</td>
                      <td>{{$Skjualbelitanah['lebar']}}</td>
                      <td>{{$Skjualbelitanah['utara']}}</td>
                      <td>{{$Skjualbelitanah['selatan']}}</td>
                      <td>{{$Skjualbelitanah['timur']}}</td>
                      <td>{{$Skjualbelitanah['barat']}}</td>
											<td>{{$Skjualbelitanah['nilai']}}</td>
											<td>{{$Skjualbelitanah['terbilang']}}</td>
                      <td>{{$Skjualbelitanah['kontan']}}</td>
                      <td>{{$Skjualbelitanah['tgl_hari_ini']}}</td>
                      <td>{{$Skjualbelitanah['nama_pihak_1']}}</td>
                      <td>{{$Skjualbelitanah['nama_pihak_2']}}</td>
                      <td>{{$Skjualbelitanah['nama_kades']}}</td>
                      <td>{{$Skjualbelitanah['saksi_1']}}</td>
                      <td>{{$Skjualbelitanah['saksi_2']}}</td>

											<td><a href="{{action('SkjualbelitanahController@edit', $Skjualbelitanah['id'])}}" class="btn btn-warning">Ubah</a><br><br>
                        <a href="{{action('SkjualbelitanahController@show', $Skjualbelitanah['id'])}}" class="btn btn-warning">Surat</a><br><br>
												<form action="{{action('SkjualbelitanahController@destroy', $Skjualbelitanah['id'])}}" method="post">
													@csrf
