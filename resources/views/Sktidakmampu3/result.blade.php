...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container">
              <form action="{{ route('Sktidakmampu3.search')}}" method="get">
            ...
            <div class="row m-t-25">
                <div class="col-sm-5 col-lg-3">
                    <table style="width: 100px" id="datatable" class="table table-striped table-bordered">
                            <tr>
                                <td>
                                    <a href="{{route ('Sktidakmampu3.create')}}" class="btn btn-primary btn-sm">Tambah Data Ket Tidak Mampu</a>
                                </td>
                            </tr>
                    </table>
                    </div>
                      ...
                      <th>AKSI</th>
									...
									<tbody>
										@foreach($result as $Sktidakmampu3)
										<tr>
											<td>{{$Sktidakmampu3['id']}}</td>
											<td>{{$Sktidakmampu3['nama']}}</td>
											<td>{{$Sktidakmampu3['jenis_kelamin']}}</td>
                      <td>{{$Sktidakmampu3['ttl']}}</td>
                      <td>{{$Sktidakmampu3['agama']}}</td>
                      <td>{{$Sktidakmampu3['status']}}</td>
                      <td>{{$Sktidakmampu3['pekerjaan']}}</td>
                      <td>{{$Sktidakmampu3['alamat']}}</td>
                      <td>{{$Sktidakmampu3['tahun']}}</td>
                      <td>{{$Sktidakmampu3['tgl_hari_ini']}}</td>
                      <td>{{$Sktidakmampu3['nama_kades']}}</td>

											<td><a href="{{action('Sktidakmampu3Controller@edit', $Sktidakmampu3['id'])}}" class="btn btn-warning">Ubah</a><br><br>
                        <a href="{{action('Sktidakmampu3Controller@show', $Sktidakmampu3['id'])}}" class="btn btn-warning">Surat</a><br><br>
												<form action="{{action('Sktidakmampu3Controller@destroy', $Sktidakmampu3['id'])}}" method="post">
													@csrf
