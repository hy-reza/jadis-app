...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container">
              <form action="{{ route('Uskjualbelitanah.search')}}" method="get">
                <input type="text" name="Uskjualbelitanah" class="form-control" placeholder="Search..." style="width: 80%; display: inline;">
            ...
            <div class="row m-t-25">
                <div class="col-sm-5 col-lg-3">
                    <table style="width: 100px" id="datatable" class="table table-striped table-bordered">
                            <tr>
                                <td>
                                    <a href="{{route ('Uskjualbelitanah.create')}}" class="btn btn-primary btn-sm">Tambah Data Ket Jual Beli Tanah</a>
                                </td>
                            </tr>
                    </table>
                    </div>
                      ...
                      <th>AKSI</th>
									...
									<tbody>
                    @foreach($result as $Uskjualbelitanah)
										<tr>
											<td>{{$Uskjualbelitanah['id']}}</td>
											<td>{{$Uskjualbelitanah['nama_lengkap']}}</td>
											<td>{{$Uskjualbelitanah['ttl']}}</td>
                      <td>{{$Uskjualbelitanah['agama']}}</td>
                      <td>{{$Uskjualbelitanah['pekerjaan']}}</td>
                      <td>{{$Uskjualbelitanah['alamat']}}</td>
                      <td>{{$Uskjualbelitanah['nama_lengkap_1']}}</td>
                      <td>{{$Uskjualbelitanah['ttl_1']}}</td>
                      <td>{{$Uskjualbelitanah['agama_1']}}</td>
                      <td>{{$Uskjualbelitanah['pekerjaan_1']}}</td>
                      <td>{{$Uskjualbelitanah['alamat_1']}}</td>
                      <td>{{$Uskjualbelitanah['panjang']}}</td>
                      <td>{{$Uskjualbelitanah['lebar']}}</td>
                      <td>{{$Uskjualbelitanah['utara']}}</td>
                      <td>{{$Uskjualbelitanah['selatan']}}</td>
                      <td>{{$Uskjualbelitanah['timur']}}</td>
                      <td>{{$Uskjualbelitanah['barat']}}</td>
											<td>{{$Uskjualbelitanah['nilai']}}</td>
											<td>{{$Uskjualbelitanah['terbilang']}}</td>
                      <td>{{$Uskjualbelitanah['kontan']}}</td>
                      <td>{{$Uskjualbelitanah['tgl_hari_ini']}}</td>
                      <td>{{$Uskjualbelitanah['nama_pihak_1']}}</td>
                      <td>{{$Uskjualbelitanah['nama_pihak_2']}}</td>
                      <td>{{$Uskjualbelitanah['nama_kades']}}</td>
                      <td>{{$Uskjualbelitanah['saksi_1']}}</td>
                      <td>{{$Uskjualbelitanah['saksi_2']}}</td>

											<td><a href="{{action('UskjualbelitanahController@edit', $Uskjualbelitanah['id'])}}" class="btn btn-warning">Ubah</a><br><br>
                        <a href="{{action('UskjualbelitanahController@show', $Uskjualbelitanah['id'])}}" class="btn btn-warning">Surat</a><br><br>
												<form action="{{action('UskjualbelitanahController@destroy', $Uskjualbelitanah['id'])}}" method="post">
													@csrf
