...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container">
              <form action="{{ route('Sktidakmampu1.search')}}" method="get">
                <input type="text" name="Sktidakmampu1" class="form-control" placeholder="Search..." style="width: 80%; display: inline;">
            ...
            <div class="row m-t-25">
                <div class="col-sm-5 col-lg-3">
                    <table style="width: 100px" id="datatable" class="table table-striped table-bordered">
                            <tr>
                                <td>
                                    <a href="{{route ('Sktidakmampu1.create')}}" class="btn btn-primary btn-sm">Tambah Data Ket Tidak Mampu</a>
                                </td>
                            </tr>
                    </table>
                    </div>
                      ...
                      <th>AKSI</th>
									...
									<tbody>
										@foreach($result as $Sktidakmampu1)
										<tr>
											<td>{{$Sktidakmampu1['id']}}</td>
											<td>{{$Sktidakmampu1['nama']}}</td>
											<td>{{$Sktidakmampu1['jenis_kelamin']}}</td>
                      <td>{{$Sktidakmampu1['ttl']}}</td>
                      <td>{{$Sktidakmampu1['kewarganegaraan']}}</td>
                      <td>{{$Sktidakmampu1['agama']}}</td>
                      <td>{{$Sktidakmampu1['status']}}</td>
                      <td>{{$Sktidakmampu1['pekerjaan']}}</td>
                      <td>{{$Sktidakmampu1['alamat']}}</td>
                      <td>{{$Sktidakmampu1['persyaratan']}}</td>
                      <td>{{$Sktidakmampu1['tgl_hari_ini']}}</td>
                      <td>{{$Sktidakmampu1['nama_berkepentingan']}}</td>
                      <td>{{$Sktidakmampu1['nama_kades']}}</td>
                      <td>{{$Sktidakmampu1['no']}}</td>
                      <td>{{$Sktidakmampu1['nama_camat']}}</td>
											<td><a href="{{action('Sktidakmampu1Controller@edit', $Sktidakmampu1['id'])}}" class="btn btn-warning">Ubah</a><br><br>
                        <a href="{{action('Sktidakmampu1Controller@show', $Sktidakmampu1['id'])}}" class="btn btn-warning">Surat</a><br><br>
												<form action="{{action('Sktidakmampu1Controller@destroy', $Sktidakmampu1['id'])}}" method="post">
													@csrf
