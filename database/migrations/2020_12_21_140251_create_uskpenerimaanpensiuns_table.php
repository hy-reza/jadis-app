...
class CreateUskpenerimaanpensiunsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('uskpenerimaanpensiuns', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('uskpenerimaanpensiuns');
    }
}
