...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container">
              <form action="{{ route('Sppindahtempat.search')}}" method="get">
                <input type="text" name="Sppindahtempat" class="form-control" placeholder="Search..." style="width: 80%; display: inline;">
            ...
            <div class="row m-t-25">
                <div class="col-sm-5 col-lg-3">
                    <table style="width: 100px" id="datatable" class="table table-striped table-bordered">
                            <tr>
                                <td>
                                    <a href="{{route ('Sppindahtempat.create')}}" class="btn btn-primary btn-sm">Tambah Data Pernyataan Pindah Tempat</a>
                                </td>
                            </tr>
                    </table>
                    </div>
                      ...
                      <th>AKSI</th>
									...
									<tbody>
										@foreach($result as $Sppindahtempat)
										<tr>
											<td>{{$Sppindahtempat['id']}}</td>
											<td>{{$Sppindahtempat['nama']}}</td>
											<td>{{$Sppindahtempat['ttl']}}</td>
                      <td>{{$Sppindahtempat['nik']}}</td>
                      <td>{{$Sppindahtempat['alamat_asal']}}</td>
                      <td>{{$Sppindahtempat['desa_kelurahan']}}</td>
                      <td>{{$Sppindahtempat['kabupaten_kota']}}</td>
                      <td>{{$Sppindahtempat['provinsi']}}</td>
                      <td>{{$Sppindahtempat['desa_kelurahan_rt_rw_tujuan']}}</td>
                      <td>{{$Sppindahtempat['kecamatan']}}</td>
                      <td>{{$Sppindahtempat['kabupaten_kota_tujuan']}}</td>
                      <td>{{$Sppindahtempat['provinsi_tujuan']}}</td>
                      <td>{{$Sppindahtempat['alasan_pindah']}}</td>
                      <td>{{$Sppindahtempat['nik_1']}}</td>
                      <td>{{$Sppindahtempat['nama_1']}}</td>
                      <td>{{$Sppindahtempat['tgl_lahir_1']}}</td>
                      <td>{{$Sppindahtempat['hubungan_keluarga_1']}}</td>
                      <td>{{$Sppindahtempat['nik_2']}}</td>
                      <td>{{$Sppindahtempat['nama_2']}}</td>
                      <td>{{$Sppindahtempat['tgl_lahir_2']}}</td>
                      <td>{{$Sppindahtempat['hubungan_keluarga_2']}}</td>
                      <td>{{$Sppindahtempat['tgl_hari_ini']}}</td>
                      <td>{{$Sppindahtempat['nama_pemohon']}}</td>
											<td><a href="{{action('SppindahtempatController@edit', $Sppindahtempat['id'])}}" class="btn btn-warning">Ubah</a><br><br>
                        <a href="{{action('SppindahtempatController@show', $Sppindahtempat['nik'])}}" class="btn btn-warning">Surat</a><br><br>
												<form action="{{action('SppindahtempatController@destroy', $Sppindahtempat['id'])}}" method="post">
													@csrf
