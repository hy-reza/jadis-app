        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Data Surat Keterangan Tidak  Mampu 1</h3> </div>
            ...
            <!-- <div class="col" align="center">
                <p>
                  <h1 class="text"><br><br><br><br><br>Anda login sebagai Administrator</h1>
						...
						<body>
              <div class="container">
								<h2>Input Data Keterangan Tidak  Mampu</h2>
								@if ($errors->any())
								...
								@endif
								<form method="post" action="{{url('Usktidakmampu1')}}">
								@csrf
              ...
              <h4 align="center">Untuk Kelengkapan Persyaratan</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="persyaratan" placeholder="kelengkapan persyaratan">
                </div>
              </div>
