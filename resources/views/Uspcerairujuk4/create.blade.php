        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Data Surat Pengajuan Cerai Rujuk 4</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Menu</a></li>
                        <li class="breadcrumb-item active">Data Surat Pengajuan Cerai Rujuk 4</li>
                    </ol>
                </div>
            </div>
            <!-- <div class="col" align="center">
                <p>
                  <h1 class="text"><br><br><br><br><br>Anda login sebagai Administrator</h1>
						...
						<body>
              <div class="container">
								<h2>Input Data Pengajuan Cerai Rujuk</h2>
								@if ($errors->any())
								...
								@endif
								<form method="post" action="{{url('Uspcerairujuk4')}}">
								@csrf
                <h2>Menerangkan dengan sebenarnya bahwa :</h2>
                <h4 align="center">Nomer Surat</h4>
              ...
              <h2> Telah menikah dibawah tangan (sirih secara agama islam) dengan : </h2>
              ...
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="nama_istri" placeholder="nama lengkap" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>
            ...
            <h4 align="center">Tempat, Tanggal Lahir</h4>
              ...
              <div class="col-md-4"></div>
              <div class="form-group col-md-4">
                <input type="text" class="form-control" name="ttl_istri" placeholder="tempat, tanggal lahir" onkeyup="this.value = this.value.toUpperCase();">
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-4"></div>
              <div class="form-group col-md-4">
                <input type="text" class="form-control" name="agama_istri" placeholder="agama" onkeyup="this.value = this.value.toUpperCase();">
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-4"></div>
              <div class="form-group col-md-4">
                <input type="text" class="form-control" name="pekerjaan_istri" placeholder="pekerjaan">
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-4"></div>
              <div class="form-group col-md-4">
                <input type="text" class="form-control" name="alamat_istri" placeholder="alamat lengkap">
              </div>
            </div>

            <h2> Dengan Wali Nikah yang bernama : </h2>
            <h4 align="center">Nama</h4>

            <div class="row">
              <div class="col-md-4"></div>
              <div class="form-group col-md-4">
                <input type="text" class="form-control" name="nama_wali" placeholder="nama lengkap" onkeyup="this.value = this.value.toUpperCase();">
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-md-4"></div>
            <div class="form-group col-md-4">
              <input type="text" class="form-control" name="ttl_wali" placeholder="tempat, tanggal lahir" onkeyup="this.value = this.value.toUpperCase();">
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-4"></div>
            <div class="form-group col-md-4">
              <input type="text" class="form-control" name="agama_wali" placeholder="agama" onkeyup="this.value = this.value.toUpperCase();">
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-4"></div>
            <div class="form-group col-md-4">
              <input type="text" class="form-control" name="alamat_wali" placeholder="alamat lengkap">
            </div>
          </div>

              <h4 align="center">Tanggal Pelaksanaan</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="date" class="form-control" name="tgl_pelaksaan" placeholder="tanggal pelaksanaan">
                </div>
              </div>

              <h4 align="center">Maskawin</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="maskawin" placeholder="maskawin">
                </div>
              </div>

              <h4 align="center">Saksi 1</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="saksi1" placeholder="nama saksi" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>

              <h4 align="center">Saksi 2</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="saksi2" placeholder="nama saksi" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="date" class="form-control" name="tgl_hari_ini" placeholder="tanggal pembuatan surat">
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="nama_kades" placeholder="Nama kepala desa" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>
