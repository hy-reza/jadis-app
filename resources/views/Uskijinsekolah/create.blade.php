        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Data Surat Keterangan Ijin Sekolah</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Menu</a></li>
                        <li class="breadcrumb-item active">Data Surat Ket. Ijin Sekolah</li>
                    </ol>
                </div>
            </div>
            <!-- <div class="col" align="center">
                <p>
                  <h1 class="text"><br><br><br><br><br>Anda login sebagai Administrator</h1>
						...
						<body>
              <div class="container">
								<h2>Input Data Keterangan Ijin Sekolah</h2>
								@if ($errors->any())
								...
								@endif
								<form method="post" action="{{url('Uskijinsekolah')}}">
								@csrf
              ...
              <h4 align="center">Kelas</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="kelas" placeholder="kelas" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>

              <h4 align="center">Nama Sekolah</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="nama_sekolah" placeholder="nama sekolah" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>

              <h4 align="center">Memperingati HUT RI ke :</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="nomer_kemerdekaan" placeholder="nomer kemerdekaan ke">
                </div>
              </div>

              <h4 align="center">Pada Tahun</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="year" class="form-control" name="tahun_kemerdekaan" placeholder="tahun kemerdekaan">
                </div>
              </div>

              <h4 align="center">Hari Diselenggarakan</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="hari" placeholder="hari diselenggarakan" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>

              <h4 align="center">Tanggal Diselenggarakannya</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="date" class="form-control" name="tgl" placeholder="tanggal diselenggarakan">
                </div>
              </div>
