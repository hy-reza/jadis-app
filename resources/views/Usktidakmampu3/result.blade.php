...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container">
              <form action="{{ route('Usktidakmampu3.search')}}" method="get">
                <input type="text" name="Usktidakmampu3" class="form-control" placeholder="Search..." style="width: 80%; display: inline;">
            ...
            <div class="row m-t-25">
                <div class="col-sm-5 col-lg-3">
                    <table style="width: 100px" id="datatable" class="table table-striped table-bordered">
                            <tr>
                                <td>
                                    <a href="{{route ('Usktidakmampu3.create')}}" class="btn btn-primary btn-sm">Tambah Data Ket Tidak Mampu</a>
                                </td>
                            </tr>
                    </table>
                    </div>
                      ...
                      <th>AKSI</th>
									...
									<tbody>
                    @foreach($result as $Usktidakmampu3)
										<tr>
											<td>{{$Usktidakmampu3['id']}}</td>
                      <td>{{$Usktidakmampu3['nomer_surat']}}</td>
											<td>{{$Usktidakmampu3['nama']}}</td>
											<td>{{$Usktidakmampu3['jenis_kelamin']}}</td>
                      <td>{{$Usktidakmampu3['ttl']}}</td>
                      <td>{{$Usktidakmampu3['agama']}}</td>
                      <td>{{$Usktidakmampu3['status']}}</td>
                      <td>{{$Usktidakmampu3['pekerjaan']}}</td>
                      <td>{{$Usktidakmampu3['alamat']}}</td>
                      <td>{{$Usktidakmampu3['tahun']}}</td>
                      <td>{{$Usktidakmampu3['tgl_hari_ini']}}</td>
                      <td>{{$Usktidakmampu3['nama_kades']}}</td>

											<td><a href="{{action('Usktidakmampu3Controller@edit', $Usktidakmampu3['id'])}}" class="btn btn-warning">Ubah</a><br><br>
                        <a href="{{action('Usktidakmampu3Controller@show', $Usktidakmampu3['id'])}}" class="btn btn-warning">Surat</a><br><br>
												<form action="{{action('Usktidakmampu3Controller@destroy', $Usktidakmampu3['id'])}}" method="post">
													@csrf
