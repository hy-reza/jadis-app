...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container">
              <form action="{{ route('Skpenerimaanpensiun.search')}}" method="get">
            ...
            <div class="row m-t-25">
                <div class="col-sm-5 col-lg-3">
                    <table style="width: 100px" id="datatable" class="table table-striped table-bordered">
                            <tr>
                                <td>
                                    <a href="{{route ('Skpenerimaanpensiun.create')}}" class="btn btn-primary btn-sm">Tambah Data Ket Penerimaan Pensiun</a>
                                </td>
                            </tr>
                    </table>
                    </div>
                      ...
                      <th>AKSI</th>
									...
									<tbody>
										@foreach($result as $Skpenerimaanpensiun)
										<tr>
											<td>{{$Skpenerimaanpensiun['id']}}</td>
											<td>{{$Skpenerimaanpensiun['nama_lengkap']}}</td>
											<td>{{$Skpenerimaanpensiun['jenis_kelamin']}}</td>
                      <td>{{$Skpenerimaanpensiun['ttl']}}</td>
                      <td>{{$Skpenerimaanpensiun['kewarganegaraan']}}</td>
                      <td>{{$Skpenerimaanpensiun['agama']}}</td>
                      <td>{{$Skpenerimaanpensiun['status_perkawinan']}}</td>
                      <td>{{$Skpenerimaanpensiun['pekerjaan']}}</td>
                      <td>{{$Skpenerimaanpensiun['alamat']}}</td>
                      <td>{{$Skpenerimaanpensiun['dipergunakaan_untuk']}}</td>
                      <td>{{$Skpenerimaanpensiun['tujuan']}}</td>
                      <td>{{$Skpenerimaanpensiun['surat_pengantar']}}</td>
                      <td>{{$Skpenerimaanpensiun['daf_kk']}}</td>
                      <td>{{$Skpenerimaanpensiun['no_ktp']}}</td>
                      <td>{{$Skpenerimaanpensiun['nama_bin']}}</td>
                      <td>{{$Skpenerimaanpensiun['tgl_hari_ini']}}</td>
                      <td>{{$Skpenerimaanpensiun['nama_pemegang']}}</td>
                      <td>{{$Skpenerimaanpensiun['nama_kades']}}</td>

											<td><a href="{{action('SkpenerimaanpensiunController@edit', $Skpenerimaanpensiun['id'])}}" class="btn btn-warning">Ubah</a><br><br>
                        <a href="{{action('SkpenerimaanpensiunController@show', $Skpenerimaanpensiun['id'])}}" class="btn btn-warning">Surat</a><br><br>
												<form action="{{action('SkpenerimaanpensiunController@destroy', $Skpenerimaanpensiun['id'])}}" method="post">
													@csrf
