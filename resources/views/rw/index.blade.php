...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container">
              <form action="{{ route('rw.search')}}" method="get">
            ...
            <div class="row m-t-25">
                <div class="col-sm-6 col-lg-3">
                    <table style="width: 100px" id="datatable" class="table table-striped table-bordered">
                            <tr>
                                <td>
                                    <a href="{{route ('rw.create')}}" class="btn btn-primary btn-sm">Tambah Data RW</a>
                                </td>
                            </tr>
                    </table>
                    </div>
                      ...
                      <th>Edit</th>
									...
									<tbody>
										...
										<tr>
											...
											<td>{{$rw['rw']}}</td>
											<td>{{$rw['alamat']}}</td>
											<td><a href="{{action('RwController@edit', $rw['id'])}}" class="btn btn-warning">Ubah</a></td>
											<td>
												<form action="{{action('RwController@destroy', $rw['id'])}}" method="post">
													@csrf
