        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Data Pernyataan Ahli Waris</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Data</a></li>
                        <li class="breadcrumb-item active">Data Pernyataan Ahli Waris</li>
                    </ol>
                </div>
            </div>
<body>
	<div class="container">
		...
		@endif
		<form method="post" action="{{action('SpahliwarisController@update', $id)}}">
			@csrf
			...
			<div class="row">
				...
				<div class="form-group col-md-4">
					...
					<input type="text" class="form-control" name="nama_alm" value="{{$Spahliwaris->nama_alm}}" onkeyup="this.value = this.value.toUpperCase();">
				</div>
			</div>
			<div class="row">
				<div class="col-md-4"></div>
				<div class="form-group col-md-4">
					<label for="name">Nomer Akte Kematian :</label>
					<input type="text" class="form-control" name="nomer_akte_kematian" value="{{$Spahliwaris->nomer_akte_kematian}}">
				</div>
			</div>
    <div class="row">
      <div class="col-md-4"></div>
      <div class="form-group col-md-4">
        ...
        <input type="text" class="form-control" name="hari" value="{{$Spahliwaris->hari}}" onkeyup="this.value = this.value.toUpperCase();">
      </div>
    </div>
  <div class="row">
    <div class="col-md-4"></div>
    <div class="form-group col-md-4">
      ...
      <input type="text" class="form-control" name="tanggal" value="{{$Spahliwaris->tanggal}}">
    </div>
  </div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    ...
    <input type="text" class="form-control" name="bulan" value="{{$Spahliwaris->bulan}}" onkeyup="this.value = this.value.toUpperCase();">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    ...
    <input type="year" class="form-control" name="tahun" value="{{$Spahliwaris->tahun}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    <label for="name">Status Sebagai Suaminya/Istrinya :</label>
    <input type="text" class="form-control" name="status_suami_istri" value="{{$Spahliwaris->status_suami_istri}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    <label for="name">Nama Suaminya/Istrinya :</label>
    <input type="text" class="form-control" name="nama_suami_istri" value="{{$Spahliwaris->nama_suami_istri}}" onkeyup="this.value = this.value.toUpperCase();">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    ...
    <input type="text" class="form-control" name="nama_anak" value="{{$Spahliwaris->nama_anak}}" onkeyup="this.value = this.value.toUpperCase();">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    <label for="name">Umur Anak :</label>
    <input type="text" class="form-control" name="umur_anak" value="{{$Spahliwaris->umur}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    <label for="name">Pekerjaan Anak :</label>
    <input type="text" class="form-control" name="pekerjaan_anak" value="{{$Spahliwaris->pekerjaan_anak}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    <label for="name">Alamat Anak :</label>
    <input type="text" class="form-control" name="alamat_anak" value="{{$Spahliwaris->alamat_anak}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    <label for="name">No Req :</label>
    <input type="text" class="form-control" name="no_req" value="{{$Spahliwaris->no_req}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    ...
    <input type="date" class="form-control" name="tgl_hari_ini" value="{{$Spahliwaris->tgl_hari_ini}}">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    ...
    <input type="text" class="form-control" name="nama_camat" value="{{$Spahliwaris->nama_camat}}" onkeyup="this.value = this.value.toUpperCase();">
  </div>
</div>
<div class="row">
  <div class="col-md-4"></div>
  <div class="form-group col-md-4">
    ...
    <input type="text" class="form-control" name="nama_kades" value="{{$Spahliwaris->nama_kades}}" onkeyup="this.value = this.value.toUpperCase();">
  </div>
</div>
		<div class="row">
			<div class="col-md-4"></div>
