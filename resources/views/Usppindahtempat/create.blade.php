            ...
            <!-- <div class="col" align="center">
                <p>
                  <h1 class="text"><br><br><br><br><br>Anda login sebagai Administrator</h1>
						...
						<body>
							<div class="container">
								<h2>Input Data Pernyataan Pindah Tempat</h2>
								@if ($errors->any())
								...
								@endif
								<form method="post" action="{{url('Usppindahtempat')}}">
								@csrf
              ...
              <h4 align="center">Alamat Asal</h4>
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="alamat_asal" placeholder="alamat_asal">
                </div>
              </div>

              <h4 align="center">Desa/Kelurahan</h4>
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="desa_kelurahan" placeholder="desa/kelurahan" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>

              <h4 align="center">Kabupaten/Kota</h4>
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="kabupaten_kota" placeholder="kabupaten/kota" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>

              <h4 align="center">Provinsi</h4>
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="provinsi" placeholder="provinsi" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>

              <h2>Data Kepindahan/ Tujuan Pindah</h2>
              <h4 align="center">Desa/Kelurahan/Rt/Rw</h4>
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="desa_kelurahan_rt_rw_tujuan" placeholder="desa/kelurahan/rt/rw_tujuan">
                </div>
              </div>

              <h4 align="center">Kecamatan</h4>
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="kecamatan" placeholder="kecamatan" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>

              <h4 align="center">Kabupaten/Kota Tujuan</h4>
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="kabupaten_kota_tujuan" placeholder="kabupaten/kota_tujuan" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>

              <h4 align="center">Provinsi Tujuan</h4>
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="provinsi_tujuan" placeholder="provinsi_tujuan" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>

              <h4 align="center">Alasan Pindah</h4>
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="alasan_pindah" placeholder="alasan_pindah">
                </div>
              </div>

              <h4 align="center">Nik Orang Pertama</h4>
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="nik_1" placeholder="nik_1">
                </div>
              </div>

              <h4 align="center">Nama Orang Pertama</h4>
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="nama_1" placeholder="nama_1" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>

              <h4 align="center">Tanggal Lahir Orang Pertama</h4>
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="date" class="form-control" name="tgl_lahir_1" placeholder="tgl_lahir_1">
                </div>
              </div>

              <h4 align="center">Hubungan Keluarga Orang Pertama</h4>
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="hubungan_keluarga_1" placeholder="hubungan_keluarga_1">
                </div>
              </div>

              <h4 align="center">Nik Orang Kedua</h4>
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="nik_2" placeholder="nik_2">
                </div>
              </div>

              <h4 align="center">Nama Orang Kedua</h4>
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="nama_2" placeholder="nama_2" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>

              <h4 align="center">Tanggal Lahir Orang Kedua</h4>
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="date" class="form-control" name="tgl_lahir_2" placeholder="tgl_lahir_2">
                </div>
              </div>

              <h4 align="center">Hubungan Keluarga Orang Kedua</h4>
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="hubungan_keluarga_2" placeholder="hubungan_keluarga_2">
                </div>
              </div>
              ...
              <h4 align="center">Nama Pemohon</h4>
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="nama_pemohon" placeholder="nama_pemohon" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>
