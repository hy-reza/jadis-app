        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Data RT</h3> </div>
            ...
            <div class="container">
              <form action="{{ route('Urt.search')}}" method="get">
                <input type="text" name="rt" class="form-control" placeholder="Search..." style="width: 80%; display: inline;">
            ...
            <div class="row m-t-25">
                <div class="col-sm-6 col-lg-3">
                    <table style="width: 100px" id="datatable" class="table table-striped table-bordered">
                            <tr>
                                <td>
                                    <a href="{{route ('Urt.create')}}" class="btn btn-primary btn-sm">Tambah Data RT</a>
                                </td>
                            </tr>
                    </table>
                    </div>
					 ...
					 <div class="container">
                      ...
                      <th>Edit</th>
									...
									<tbody>
										@foreach($result as $Urt)
										<tr>
											<td>{{$Urt['id']}}</td>
											<td>{{$Urt['rt']}}</td>
											<td>{{$Urt['alamat']}}</td>
											<td><a href="{{action('UrtController@edit', $Urt['id'])}}" class="btn btn-warning">Ubah</a></td>
											<td>
												<form action="{{action('UrtController@destroy', $Urt['id'])}}" method="post">
													@csrf
