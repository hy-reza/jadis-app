...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container">
              <form action="{{ route('Spcerairujuk1.search')}}" method="get">
                <input type="text" name="Spcerairujuk1" class="form-control" placeholder="Search..." style="width: 80%; display: inline;">
            ...
            <div class="row m-t-25">
                <div class="col-sm-5 col-lg-3">
                    <table style="width: 100px" id="datatable" class="table table-striped table-bordered">
                            <tr>
                                <td>
                                    <a href="{{route ('Spcerairujuk1.create')}}" class="btn btn-primary btn-sm">Tambah Data Pengajuan Cerai Rujuk</a>
                                </td>
                            </tr>
                    </table>
                    </div>
                      ...
                      <th>AKSI</th>
									...
									<tbody>
										@foreach($result as $Spcerairujuk1)
										<tr>
											<td>{{$Spcerairujuk1['id']}}</td>
											<td>{{$Spcerairujuk1['nama']}}</td>
											<td>{{$Spcerairujuk1['umur']}}</td>
                      <td>{{$Spcerairujuk1['pekerjaan']}}</td>
                      <td>{{$Spcerairujuk1['alamat']}}</td>
                      <td>{{$Spcerairujuk1['nama_sah']}}</td>
                      <td>{{$Spcerairujuk1['umur_sah']}}</td>
                      <td>{{$Spcerairujuk1['pekerjaan_sah']}}</td>
                      <td>{{$Spcerairujuk1['alamat_sah']}}</td>
                      <td>{{$Spcerairujuk1['lama_tahun']}}</td>
                      <td>{{$Spcerairujuk1['lama_bulan']}}</td>
                      <td>{{$Spcerairujuk1['tgl_hari_ini']}}</td>
                      <td>{{$Spcerairujuk1['nama_pelapor']}}</td>
                      <td>{{$Spcerairujuk1['nama_kades']}}</td>
											<td><a href="{{action('Spcerairujuk1Controller@edit', $Spcerairujuk1['id'])}}" class="btn btn-warning">Ubah</a><br><br>
                        <a href="{{action('Spcerairujuk1Controller@show', $Spcerairujuk1['id'])}}" class="btn btn-warning">Surat</a><br><br>
												<form action="{{action('Spcerairujuk1Controller@destroy', $Spcerairujuk1['id'])}}" method="post">
													@csrf
