        ...
        <div class="page-wrapper">
            ...
            <!-- <div class="col" align="center">
              ...
              <div class="container">
								...
								@endif
								<form method="post" action="{{url('Uspcerairujuk1')}}">
								@csrf
              ...
              <h4 align="center">Umur</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="umur" placeholder="1 tahun">
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="umur_sah" placeholder="1 tahun">
                </div>
              </div>
              ...
              <h4 align="center">Lama Tahun</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="lama_tahun" placeholder="tiga belas (13)">
                </div>
              </div>

              <h4 align="center">Lama Bulan</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="lama_bulan" placeholder="enam (6)">
                </div>
              </div>
              ...
              <h4 align="center">Nama Pelapor</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="nama_pelapor" placeholder="pelapor" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>
