        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Data Surat Keterangan Meninggal Dunia</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Menu</a></li>
                        <li class="breadcrumb-item active">Data Surat Ket. Meninggal Dunia</li>
                    </ol>
                </div>
            </div>
            <!-- <div class="col" align="center">
                <p>
                  <h1 class="text"><br><br><br><br><br>Anda login sebagai Administrator</h1>
						...
						<body>
              <div class="container">
								<h2>Input Data Keterangan Meninggal Dunia</h2>
								@if ($errors->any())
								...
								@endif
								<form method="post" action="{{url('Uskmeninggaldunia')}}">
								@csrf
                ...
                <h4 align="center">Nomer Surat</h4>
                    ...
                    <input type="text" class="form-control" name="nomer_surat" placeholder="nome surat">
									</div>
								</div>

                <h4 align="center">Hari</h4>
              ...
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="nama_alm" placeholder="nama_alm" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>

              <h4 align="center">Umur Almarhum</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="umur_alm" placeholder="umur">
                </div>
              </div>

              <h4 align="center">RT</h4>
              ...
              <h4 align="center">Almarhum Meninggal disebabkan karena </h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="penyebab_meninggal" placeholder="penyebab_meninggal">
                </div>
              </div>

              <h4 align="center">Nama saudara</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="nama_saudara" placeholder="nama_saudara" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>

              <h4 align="center">Tempat Bekerja</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="tempat_bekerja" placeholder="tempat_bekerja">
                </div>
              </div>

              <h4 align="center">tgl_hari_ini</h4>
