...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container">
              <form action="{{ route('Uspcerairujuk3.search')}}" method="get">
                <input type="text" name="Uspcerairujuk3" class="form-control" placeholder="Search..." style="width: 80%; display: inline;">
                ...
                <div class="col-sm-5 col-lg-3">
                    <table style="width: 100px" id="datatable" class="table table-striped table-bordered">
                      ...
                      <th>Nomer Surat</th>
											<th>Nama</th>
											<th>Alamat</th>
                      <th>Nama Ortu Angkat</th>
                      <th>Alamat Ortu Angkat</th>
                      <th>Nama Anak</th>
                      <th>Jenis Kelamin</th>
                      ...
                      <th>AKSI</th>
									...
									<tbody>
                    @foreach($result as $Uspcerairujuk3)
										<tr>
											<td>{{$Uspcerairujuk3['id']}}</td>
                      <td>{{$Uspcerairujuk3['nomer_surat']}}</td>
											<td>{{$Uspcerairujuk3['nama']}}</td>
											<td>{{$Uspcerairujuk3['alamat']}}</td>
                      <td>{{$Uspcerairujuk3['nama_angkat']}}</td>
                      <td>{{$Uspcerairujuk3['alamat_angkat']}}</td>
                      <td>{{$Uspcerairujuk3['nama_anak']}}</td>
                      <td>{{$Uspcerairujuk3['jenis_kelamin']}}</td>
                      <td>{{$Uspcerairujuk3['tempat']}}</td>
                      <td>{{$Uspcerairujuk3['tgl_hari_ini']}}</td>
                      <td>{{$Uspcerairujuk3['nama_kades']}}</td>
											<td><a href="{{action('Uspcerairujuk3Controller@edit', $Uspcerairujuk3['id'])}}" class="btn btn-warning">Ubah</a><br><br>
                        <a href="{{action('Uspcerairujuk3Controller@show', $Uspcerairujuk3['id'])}}" class="btn btn-warning">Surat</a><br><br>
												<form action="{{action('Uspcerairujuk3Controller@destroy', $Uspcerairujuk3['id'])}}" method="post">
													@csrf
