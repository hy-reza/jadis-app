        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Data Pengajuan Cerai Rujuk 4</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Data</a></li>
                        <li class="breadcrumb-item active">Data Pengajuan Cerai Rujuk 4</li>
                    </ol>
                </div>
            </div>
<body>
	<div class="container">
		...
		@endif
		<form method="post" action="{{action('Uspcerairujuk4Controller@update', $id)}}">
			@csrf
			...
			<div class="row">
				...
				<div class="form-group col-md-4">
					...
					<input type="text" class="form-control" name="nomer_surat" value="{{$Uspcerairujuk4->nomer_surat}}" onkeyup="this.value = this.value.toUpperCase();">
				</div>
			</div>
			<div class="row">
				<div class="col-md-4"></div>
				<div class="form-group col-md-4">
					...
					<input type="text" class="form-control" name="nama" value="{{$Uspcerairujuk4->nama}}" onkeyup="this.value = this.value.toUpperCase();">
				</div>
			</div>
			<div class="row">
				<div class="col-md-4"></div>
				<div class="form-group col-md-4">
					...
					<input type="text" class="form-control" name="ttl" value="{{$Uspcerairujuk4->ttl}}" onkeyup="this.value = this.value.toUpperCase();">
				</div>
			</div>
    	<div class="row">
      	<div class="col-md-4"></div>
      	<div class="form-group col-md-4">
        	...
        	<input type="text" class="form-control" name="agama" value="{{$Uspcerairujuk4->agama}}" onkeyup="this.value = this.value.toUpperCase();">
      	</div>
    	</div>
  	<div class="row">
    	<div class="col-md-4"></div>
    	<div class="form-group col-md-4">
      	...
      	<input type="text" class="form-control" name="pekerjaan" value="{{$Uspcerairujuk4->pekerjaan}}">
    	</div>
  	</div>
		<div class="row">
  		<div class="col-md-4"></div>
  		<div class="form-group col-md-4">
    		...
    		<input type="text" class="form-control" name="alamat" value="{{$Uspcerairujuk4->alamat}}">
  		</div>
		</div>
		<div class="row">
  		<div class="col-md-4"></div>
  		<div class="form-group col-md-4">
    		...
    		<input type="text" class="form-control" name="nama_istri" value="{{$Uspcerairujuk4->nama_istri}}" onkeyup="this.value = this.value.toUpperCase();">
  		</div>
		</div>
		<div class="row">
  		<div class="col-md-4"></div>
  		<div class="form-group col-md-4">
    		...
    		<input type="text" class="form-control" name="ttl_istri" value="{{$Uspcerairujuk4->ttl_istri}}" onkeyup="this.value = this.value.toUpperCase();">
  		</div>
		</div>
		<div class="row">
			<div class="col-md-4"></div>
			<div class="form-group col-md-4">
  			...
  			<input type="text" class="form-control" name="agama_istri" value="{{$Uspcerairujuk4->agama_istri}}" onkeyup="this.value = this.value.toUpperCase();">
			</div>
		</div>
		<div class="row">
			<div class="col-md-4"></div>
			<div class="form-group col-md-4">
				...
				<input type="text" class="form-control" name="pekerjaan_istri" value="{{$Uspcerairujuk4->pekerjaan_istri}}">
			</div>
		</div>
		<div class="row">
			<div class="col-md-4"></div>
			<div class="form-group col-md-4">
				...
				<input type="text" class="form-control" name="alamat_istri" value="{{$Uspcerairujuk4->alamat_istri}}">
			</div>
		</div>
		<div class="row">
  		<div class="col-md-4"></div>
  		<div class="form-group col-md-4">
    		...
    		<input type="text" class="form-control" name="nama_wali" value="{{$Uspcerairujuk4->nama_wali}}" onkeyup="this.value = this.value.toUpperCase();">
  		</div>
		</div>
		<div class="row">
  		<div class="col-md-4"></div>
  		<div class="form-group col-md-4">
    		...
    		<input type="text" class="form-control" name="ttl_wali" value="{{$Uspcerairujuk4->ttl_wali}}" onkeyup="this.value = this.value.toUpperCase();">
  		</div>
		</div>
		<div class="row">
			<div class="col-md-4"></div>
			<div class="form-group col-md-4">
  			...
  			<input type="text" class="form-control" name="agama_wali" value="{{$Uspcerairujuk4->agama_wali}}" onkeyup="this.value = this.value.toUpperCase();">
			</div>
		</div>
		<div class="row">
			<div class="col-md-4"></div>
			<div class="form-group col-md-4">
				...
				<input type="text" class="form-control" name="pekerjaan_wali" value="{{$Uspcerairujuk4->pekerjaan_wali}}">
			</div>
		</div>
		<div class="row">
			<div class="col-md-4"></div>
			<div class="form-group col-md-4">
				...
				<input type="text" class="form-control" name="alamat_wali" value="{{$Uspcerairujuk4->alamat_wali}}">
			</div>
		</div>
		<div class="row">
  		<div class="col-md-4"></div>
  		<div class="form-group col-md-4">
    		...
    		<input type="date" class="form-control" name="tgl_pelaksaan" value="{{$Uspcerairujuk4->tgl_pelaksaan}}">
  		</div>
		</div>
		<div class="row">
  		<div class="col-md-4"></div>
  		<div class="form-group col-md-4">
    		...
    		<input type="text" class="form-control" name="maskawin" value="{{$Uspcerairujuk4->maskawin}}">
  			</div>
		</div>
		<div class="row">
  		<div class="col-md-4"></div>
  		<div class="form-group col-md-4">
    		...
    		<input type="text" class="form-control" name="saksi1" value="{{$Uspcerairujuk4->saksi1}}" onkeyup="this.value = this.value.toUpperCase();">
  		</div>
		</div>
		<div class="row">
  		<div class="col-md-4"></div>
  		<div class="form-group col-md-4">
    		...
    		<input type="text" class="form-control" name="saksi2" value="{{$Uspcerairujuk4->saksi2}}" onkeyup="this.value = this.value.toUpperCase();">
  		</div>
		</div>
		<div class="row">
  		<div class="col-md-4"></div>
  		<div class="form-group col-md-4">
    		...
    		<input type="date" class="form-control" name="tgl_hari_ini" value="{{$Uspcerairujuk4->tgl_hari_ini}}">
  		</div>
		</div>
		<div class="row">
  		<div class="col-md-4"></div>
  		<div class="form-group col-md-4">
    		...
    		<input type="text" class="form-control" name="nama_kades" value="{{$Uspcerairujuk4->nama_kades}}" onkeyup="this.value = this.value.toUpperCase();">
  		</div>
		</div>
		<div class="row">
			<div class="col-md-4"></div>
