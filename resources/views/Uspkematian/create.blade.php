        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Data Surat Pernyataan Kematian</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Menu</a></li>
                        <li class="breadcrumb-item active">Data Surat Pernyataan Kematian</li>
                    </ol>
                </div>
            </div>
            <!-- <div class="col" align="center">
                <p>
                  <h1 class="text"><br><br><br><br><br>Anda login sebagai Administrator</h1>
						...
						<body>
              <div class="container">
								<h2>Input Data Pernyataan Kematian</h2>
								@if ($errors->any())
								...
								@endif
								<form method="post" action="{{url('Uspkematian')}}">
								@csrf
              ...
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="status_hubungan_keluarga" placeholder="status hubungan keluarga">
                </div>
              </div>

              <h2> Dengan ini menyatakan bahwa yang tersebut dibawah ini :</h2>

              <h4 align="center">Nama</h4>
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="nama_meninggal" placeholder="nama ALM" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="nik_meninggal" placeholder="nik ALM">
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="nomor_kk_meninggal" placeholder="nomor kk ALM">
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="ttl_meninggal" placeholder="tempat tanggal lahir ALM" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="alamat_meninggal" placeholder="alamat lengkap ALM">
                </div>
              </div>

              <h4 align="center">Tanggal Meninggal Dunia</h4>
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="date" class="form-control" name="tanggal_meninggal" placeholder="tanggal meninggal">
                </div>
              </div>

              <h4 align="center">Pukul</h4>
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="time" class="form-control" name="pukul_meninggal" placeholder="pukul meninggal">
                </div>
              </div>

              <h4 align="center">Di alamat</h4>
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="dialamat_meninggal" placeholder="dialamat meninggal">
                </div>
              </div>
              ...
              <h4 align="center">Nama Ketua RT</h4>
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="nama_rt" placeholder="nama rt" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>
              ...
              <h4 align="center">Nama Ketua RW</h4>
              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="nama_rw" placeholder="nama rw" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>
							<div class="row">
								<div class="col-md-4"></div>
