        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Data Surat Keterangan Penerimaan Pensiun</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Menu</a></li>
                        <li class="breadcrumb-item active">Data Surat Ket. Penerimaan Pensiun</li>
                    </ol>
                </div>
            </div>
            <!-- <div class="col" align="center">
                <p>
                  <h1 class="text"><br><br><br><br><br>Anda login sebagai Administrator</h1>
						...
						<body>
              <div class="container">
								<h2>Input Data Keterangan Penerimaan Pensiun</h2>
								@if ($errors->any())
								...
								@endif
								<form method="post" action="{{url('Uskpenerimaanpensiun')}}">
								@csrf
              ...
              <h4 align="center">jenis_kelamin</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="jenis_kelamin" placeholder="jenis_kelamin" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>
              ...
              <h4 align="center"> Kewarganegaraan</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="kewarganegaraan" placeholder="kewarganegaraan" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>
              ...
              <h4 align="center">status_perkawinan</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="status_perkawinan" placeholder="status_perkawinan" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>
              ...
              <h4 align="center">Dipergunakan Untuk</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="dipergunakaan_untuk" placeholder="dipergunakaan_untuk">
                </div>
              </div>
              ...
              <h4 align="center">Surat Pengantar Dari</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="surat_pengantar" placeholder="surat_pengantar">
                </div>
              </div>

              <h4 align="center">Daf Kartu Keluarga</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="daf_kk" placeholder="daf_kk">
                </div>
              </div>

              <h4 align="center">No KTP</h4>
              ...
              <h4 align="center">Yang tercantum dalam SK Penerimaan Pensiun</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="nama_bin" placeholder="nama_bin" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>
              ...
              <h4 align="center">Nama Pemegang Surat</h4>

              <div class="row">
                <div class="col-md-4"></div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" name="nama_pemegang" placeholder="nama_pemegang_surat" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>
