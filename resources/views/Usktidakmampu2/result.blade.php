...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container">
              <form action="{{ route('Usktidakmampu2.search')}}" method="get">
                <input type="text" name="Usktidakmampu2" class="form-control" placeholder="Search..." style="width: 80%; display: inline;">
            ...
            <div class="row m-t-25">
                <div class="col-sm-5 col-lg-3">
                    <table style="width: 100px" id="datatable" class="table table-striped table-bordered">
                            <tr>
                                <td>
                                    <a href="{{route ('Usktidakmampu2.create')}}" class="btn btn-primary btn-sm">Tambah Data Ket Tidak Mampu</a>
                                </td>
                            </tr>
                    </table>
                    </div>
                      ...
                      <th>AKSI</th>
									...
									<tbody>
                    @foreach($result as $Usktidakmampu2)
										<tr>
											<td>{{$Usktidakmampu2['id']}}</td>
                      <td>{{$Usktidakmampu2['nomer_surat']}}</td>
                      ...
                      <td>{{$Usktidakmampu2['nama_camat']}}</td>
											<td><a href="{{action('Usktidakmampu2Controller@edit', $Usktidakmampu2['id'])}}" class="btn btn-warning">Ubah</a><br><br>
                        <a href="{{action('Usktidakmampu2Controller@show', $Usktidakmampu2['id'])}}" class="btn btn-warning">Surat</a><br><br>
												<form action="{{action('Usktidakmampu2Controller@destroy', $Usktidakmampu2['id'])}}" method="post">
													@csrf
